<%@ Page Title="" Language="C#" MasterPageFile="~/BiddingAdmin.Master" AutoEventWireup="true" CodeBehind="ViewPrForQuotationComparison.aspx.cs" Inherits="BiddingSystem.ViewPrForQuotationComparison" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentSection" runat="server">
 ...
 <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Bid Comprison</li>
      </ol>
    </section> 
    <br />
                ...
                <asp:GridView runat="server" ID="gvPurchaseRequest" GridLines="None" CssClass="table table-responsive" HeaderStyle-BackColor="#3C8DBC" HeaderStyle-ForeColor="White"
                    ...
                    <Columns>
                        <asp:BoundField DataField="PrId"  HeaderText="PrId" HeaderStyle-CssClass="hidden" ItemStyle-CssClass="hidden"/>
                             ...
                             <%-- <asp:BoundField DataField="MesurementId"
                                                        HeaderText="MSID" HeaderStyle-CssClass="hidden"
                        ...
                        <asp:TemplateField HeaderText="Action">
                            <ItemTemplate>
                                <asp:LinkButton runat="server" ID="lbtnView"  CssClass="btn btn-info btn-styled" Text="View Bids" OnClick="btnView_Click"></asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
                </asp:GridView>
