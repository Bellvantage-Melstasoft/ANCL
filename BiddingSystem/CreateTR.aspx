<%@ Page Title="" Language="C#" MasterPageFile="~/BiddingAdmin.Master" AutoEventWireup="true" CodeBehind="CreateTR.aspx.cs" Inherits="BiddingSystem.CreateTR" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentSection" runat="server">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Transfer Request</li>
      </ol>
    </section>
    <br />
    ...
    <form id="form1" runat="server" enctype="multipart/form-data">
                    ...
                    <div id="SuccessAlert" class="modal fade">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <p style="font-weight: bold; font-size: medium;">TR has been created Successfully</p>
                                </div>
                                <div class="modal-footer">
     ...
     <div class="box box-primary" id="topPanel">
          ...
          <div class="row">
             <div class="col-md-6">
                ...
                <div class="form-group">
                  ...
                  <asp:TextBox ID="dtExpectedDate" runat="server"  CssClass="form-control date1" autocomplete="off" DataFormatString="{0:dd/MM/yyyy HH:mm}" ></asp:TextBox>
                </div>
                 <div class="form-group">
                    <label for="exampleInputEmail1">Description</label><label id="lblRequestBy" style="color:red;"></label>
                   <asp:TextBox ID="txtTrDescription" runat="server" TextMode="MultiLine" Rows="5" CssClass="form-control"></asp:TextBox>
                </div>
              <!-- /.form-group -->
            </div>
              <div class="col-md-6">
                  ...
                  <div class="form-group">
                    <label for="exampleInputEmail1">Select Your Warehouse</label>
                  ...
                  <div class="form-group">
                    <label for="exampleInputEmail1">Your Warehouse Heads</label>
                    <asp:TextBox ID="txtWarehouseHeads" runat="server" CssClass="form-control"></asp:TextBox>
                       
                </div>
                  
                  <div class="form-group">
                    <label for="exampleInputEmail1">Select Requesting Warehouse</label>
                      <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator8" ForeColor="Red" Font-Bold="true" InitialValue=""  ControlToValidate="ddlWarehouse" ValidationGroup="btnSavePR1">*</asp:RequiredFieldValidator>     
          ...
          <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                    ...
                    <asp:DropDownList ID="ddlMainCateGory" runat="server" CssClass="form-control ddlMainCategoryCl"  
                        AutoPostBack="true" 
                ...
                <div class="form-group">
                    ...
                    <asp:DropDownList ID="ddlSubCategory" runat="server" CssClass="form-control ddlSubCategoryCl"  AutoPostBack="true" OnSelectedIndexChanged="ddlSubCategory_SelectedIndexChanged"></asp:DropDownList>
                </div>
                  <div class="row">
                      <div class="col-md-8">
                         <div class="form-group">
                            <label for="exampleInputEmail1">Item Name</label>
                              ...
                              <asp:DropDownList ID="ddlItemName" runat="server" CssClass="form-control ddlItemCl" AutoPostBack="true" OnSelectedIndexChanged="ddlItemName_SelectedIndexChanged" ></asp:DropDownList>
                  ...
                  <div class="row">
                    ...
                    <asp:TextBox ID="txtQty" runat="server" min="0.01" step=".01" CssClass="form-control" placeholder="" type="number"></asp:TextBox>
                    ...
                    <asp:DropDownList ID="ddlMeasurement" runat="server" CssClass="form-control" AutoPostBack="true" OnSelectedIndexChanged="ddlMeasurement_SelectedIndexChanged"></asp:DropDownList>
                 ...
                 <div class="form-group">
                    <label for="exampleInputEmail1">Item Description</label>
                     <asp:TextBox ID="txtTrdDescription" TextMode="MultiLine" runat="server" CssClass="form-control" placeholder=""></asp:TextBox>
                </div>
      ...
      <div class="box box-primary">
         ...
         <div class="col-md-12">
                            <asp:GridView ID="gvDatataTable" runat="server" EmptyDataText="No Items Found" AutoGenerateColumns="false" CssClass="table table-responsive table-striped"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="MainCategoryName" HeaderText="Category Name" HtmlEncode="false" />
                                    ...
                                    <asp:BoundField DataField="ShortName" HeaderText="Unit" />
        ...
        <div class="form-group">
              <label for="exampleInputEmail1" style="visibility:hidden">Category Name</label>
              <asp:Button ID="btnSavePR"  runat="server" Text="Create Transfer Request"   CssClass="btn btn-primary pull-right" OnClick="btnSavePR_Click"></asp:Button>
          </div>
        </div>
        </div>
        </div>
    ...
    <script type="text/javascript">
        Sys.Application.add_load(function () {
            ...
            $(function () {
                ...
                $('.ddlMainCategoryCl').select2();
                $('.ddlSubCategoryCl').select2();
                $('.ddlItemCl').select2();
            });
        });
