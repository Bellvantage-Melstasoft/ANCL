<%@ Page Title="" Language="C#" MasterPageFile="~/BiddingAdmin.Master" AutoEventWireup="true" CodeBehind="RecommendQuotationsItemWiseImportSparePart.aspx.cs" Inherits="BiddingSystem.RecommendQuotationsItemWiseImportSparePart" %>
    ...
    <form runat="server">
        ...
        <asp:UpdatePanel ID="Updatepanel1" runat="server" ChildrenAsTriggers="true" UpdateMode="Conditional">
            <ContentTemplate>
                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        ...
                                        <div style="color: black; overflow-x: scroll;">
                                                                        ...
                                                                        <asp:GridView ID="gvQuotationItems" runat="server"
                                                                            ...
                                                                            <Columns>
                                                                               ...
                                                                               <%-- <asp:BoundField DataField="ImpCurrencyName" HeaderText="Currency" NullDisplayText="-" />--%>
                                                                                ...
                                                                                <asp:BoundField DataField="UnitPriceForeign" HeaderText="UnitPrice (Foreign)" />
                                                                                <asp:BoundField DataField="UnitPriceLocal" HeaderText="UnitPrice (Local)" />
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="col-md-2 topMargin">
                                                        <asp:Label runat="server" Text="Tabulation Remark"></asp:Label><br>
                                                    </div>
                                                                    ...
                                                                    <colgroup>
                                                                        <col width="30">
                                                                            <col width="200">
                                                                                ...
                                                                                <%--<tr>
                                                                                    <td><b>NBT</b></td>
                                                                                    <td id="tdNbt" runat="server" class="text-right">
                                            ...
                                            <asp:Button CssClass="btn btn-warning pull-right" runat="server"
                                            ...
                                            <asp:Button CssClass="btn btn-success pull-right" runat="server"
                                                ID="viewRecomendationNew" Text="Recomendation" OnClick="btnViewRecommendations_Click"
                ...
                <!-- Start : Quotations Modal -->
                <div id="modlRejectedTabulationsNew" class="modal fade" tabindex="-1" role="dialog" style="z-index: 3000;"
                    aria-hidden="true">
                    <div class="modal-dialog" style="width: 95%;">
                        <!-- Start : Modal Content -->
                        <div class="modal-content">
                            ...
                            <div class="modal-header" style="background-color: #3C8DBC; color: white">
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close" style="opacity: 1; color: white;">
                                    <span aria-hidden="true" style="opacity: 1;">×</span></button>
                                <h4 class="modal-title">Rejected Tabulation Sheets</h4>
                            </div>
                            <!-- End : Modal Header -->
                            <!-- Start : Modal Body -->
                            <div class="modal-body">
                                <div class="row">
                                    <div class="col-xs-12">
                                        <!-- Start : Quotation Table -->
                                        <div style="color: black; margin-left: 40px; overflow-x: scroll;">

                                            <asp:GridView ID="gvRejectedTabulationsNew" runat="server"
                                                CssClass="table gvItems"
                                                                    ...
                                                                    <colgroup>
                                                                        <col width="30">
                                                                            <col width="200">
                                                                               ...
                                                                               <%-- <tr>
                                                                                    <td><b>NBT</b></td>
                                                                                    <td id="td3" runat="server" class="text-right">
                                            ...
                                            <%--<asp:Button CssClass="btn btn-success pull-right" runat="server"
                                                ID="Button6" Text="Recomendation" OnClick="btnViewRecommendations_Click"
                                                Style="margin-top: 50px; margin-right:5px; width: 120px;"></asp:Button>--%>

                                            <%--<asp:Button CssClass="btn btn-info pull-right " runat="server"
                                                ID="btnRejectNew" Text="Print" OnClick="btnPrint1_Click"
                                                Style="margin-top: 50px; margin-right: 5px; width: 100px; margin-right: 5px;"></asp:Button>--%>
                ...
                <div id="mdlAttachments" class="modal fade" tabindex="-1" role="dialog" style="z-index: 3000;"
                    ...
                    <div class="modal-dialog">
                        ...
                        <div class="modal-content">
                            <!-- Start : Modal Header -->
                            <div class="modal-header" style="background-color: #3C8DBC; color: white">
                                <button type="button" class="close clAttachments" data-dismiss="modal" aria-label="Close" style="opacity: 1; color: white;">
                                    <span aria-hidden="true" style="opacity: 1;">×</span></button>
                    ...
                    <div class="modal-dialog" style="width: 90%;">
                        ...
                        <div class="modal-content">
                                            ...
                                            <asp:Panel ID="Panel1" runat="server">
                                                <asp:GridView ID="gvRecommenations" runat="server" CssClass="ChildGrid" Width="100%"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <%--<asp:BoundField DataField="RecommendedDate" HeaderText="Recommended Date" NullDisplayText="-"/>--%>
                                                        ...
                                                        <asp:TemplateField HeaderText="TEC Committee Decision" HeaderStyle-Width="150px" ItemStyle-Width="150px">
                                                            <ItemTemplate>
                                                                ...
                                                                <asp:Button CssClass="btn btn-xs btn-danger btnOverrideRecommendationRejectCl" runat="server"
                                                                    ID="Button2" Text="Override and Reject" Enabled='<%#Eval("IsPORaisedforPRDetail").ToString() =="1"?false: true%>'
                                                                    Style="margin-top: 3px; width: 150px;" Visible='<%#Eval("CanLoggedInUserOverride").ToString() =="1"?true: false%>'></asp:Button>
                                                                ...
                                                                <asp:Button CssClass="btn btn-xs btn-danger btnRejectCl" runat="server"
                                                                    ID="btnRejectQ" Text="Reject" Enabled='<%#Eval("IsPORaisedforPRDetail").ToString() =="1"?false: true%>'
                                                                    Style="margin-top: 3px; width: 150px;" Visible='<%#Eval("CanLoggedInUserRecommend").ToString() =="1"?true: false%>'></asp:Button>
                                                                <asp:Button CssClass="btn btn-xs btn-warning btnHold" runat="server"
                                                                    ID="Button5" Text="Hold"
                                                                    Style="margin-top: 3px; width: 150px;" Visible='<%#Eval("CanLoggedInUserRecommend").ToString() =="1"?true: false%>'></asp:Button>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                            ...
                            <div class="modal-footer">
                                ...
                                <asp:Button ID="btnOverrideRecomnd" runat="server" Text="Override & Recommend" CssClass="btn btn-success pull-right btnOverrideApprove" Style="margin-right: 10px" />
                                            ...
                                            <div class="table-responsive">
                                                <asp:GridView ID="gvBids" runat="server" CssClass="table table-responsive"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <%-- <asp:TemplateField HeaderText="Upload Docs" HeaderStyle-Width="110px" ItemStyle-Width="110px">
                                                            <ItemTemplate>
                                                                <asp:Button CssClass="btn btn-xs btn-warning" runat="server"
                                                                    ID="btnuplodDocks" Text="Upload Docs" OnClick="btnuplodDock_Click"
                                                                    Style="margin-top: 3px; width: 100px;"></asp:Button>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>--%>
                                                        ...
                                                        <asp:TemplateField HeaderText="Actions" HeaderStyle-Width="110px" ItemStyle-Width="110px">
                                                            ...
                                                            <%--    <asp:Button CssClass="btn btn-xs btn-primary" runat="server"
                                                                ...
                                                                <asp:Button CssClass="btn btn-xs btn-primary" runat="server"
                                                                    ID="Button4" Text="Tabulation Sheet" OnClick="btnViewNew_Click"
                                                                    style="width:120px;"></asp:Button>
                                                        ...
                                                        <asp:TemplateField HeaderText="View" HeaderStyle-Width="110px" ItemStyle-Width="110px">
                                                            <ItemTemplate>
                                                               <%-- <asp:Button CssClass="btn btn-xs btn-danger" runat="server"
                                                                 ...
                                                                 <asp:Button CssClass="btn btn-xs btn-primary" runat="server"
                                                                    ID="btnRejectedViewNew" Text="Tabulation Sheet" OnClick="btnRejectedViewNew_Click"
                                                                    style="width:100px;"></asp:Button>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                    </Columns>
                ...
                <asp:Button ID="btnHold" runat="server" OnClick="btnHold_Click" CssClass="hidden" />
                <asp:HiddenField ID="hdnHoldRemarks" runat="server" />
                <!-- End : Hidden Fields -->
...
<%--                <asp:PostBackTrigger ControlID="btnRejectNew" />--%>
            </Triggers>
        </asp:UpdatePanel>
            ...
            $(function () {
                ...
                $('#mdlAttachments').on('hide.bs.modal', function () {
                    ...
                    if (hAttachments == 1) {
                        ...
                        $('.modal-backdrop').remove();
                        $('#modlRejectedTabulationsNew').modal('show');
                    }
                });
                ...
                $('#modlRejectedTabulationsNew').on('shown.bs.modal', function () {
                    $('#modlRejectedTabulationsNew').css('overflow', 'auto');
                    $('body').css("overflow", "hidden");
                    $('body').css("padding-right", "0");
                })

                $('#modlRejectedTabulationsNew').on('hidden.bs.modal', function () {
                    $('body').css("overflow", "auto");
                    $('body').css("padding-right", "0");
                })
                ...
                $('.btnHold').on({
                    click: function () {
                        ...
                        var tableRow = $(this).closest('tr').find('> td:not(table)');
                        $('#ContentSection_hdnRecommendationId').val($(tableRow).eq(0).text());
                        $('#ContentSection_hdnTabulationId').val($(tableRow).eq(1).text());

                        swal.fire({
                            title: 'Are you sure?',
                            html: "Are you sure you want to <strong>Hold</strong> selected Quotation?</br></br>"
                                + "<strong id='dd'>Remarks</strong>"
                                + "<input id='ss' type='text' class ='form-control' required='required'/></br>",
                            type: 'warning',
                            confirmButtonColor: '#d33',
                            ...
                            preConfirm: function () {
                                ...
                                $('#ContentSection_hdnHoldRemarks').val($('#ss').val());

                            }
                        }
                        ).then((result) => {
                            if (result.value) {
                                $('#ContentSection_btnHold').click();
                            } else if (
                                result.dismiss === Swal.DismissReason.cancel
                            ) {
