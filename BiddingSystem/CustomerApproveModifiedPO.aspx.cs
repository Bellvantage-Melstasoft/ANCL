...
{
    public partial class CustomerApproveModifiedPO : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (Session["CompanyId"] != null && Session["UserId"].ToString() != null)
            {
                ...
                ((BiddingAdmin)Page.Master).subTabValue = "CustomerApproveModifiedPO.aspx";
                ((BiddingAdmin)Page.Master).subTabId = "CustomerApproveModifiedPOLink";
              ...
              //  UserId = Session["UserId"].ToString();
               var companyLogin = companyLoginController.GetUserbyuserId(int.Parse(Session["UserId"].ToString()));
                ...
                if ((!companyUserAccessController.isAvilableAccess(int.Parse(Session["UserId"].ToString()), int.Parse(Session["CompanyId"].ToString()), 6, 23) && companyLogin.Usertype != "S") && companyLogin.Usertype != "GA")
                {
            ...
            if (!IsPostBack)
            {
                if (int.Parse(Session["UserId"].ToString()) != 0)
                {
                        ...
                        try
                    {
                        ...
                        pOMasterListByDepartmentid = pOMasterController.GetModifiedPosForApproval(int.Parse(Session["CompanyId"].ToString()), int.Parse(Session["UserId"].ToString()));
        ...
        protected void btnView_Click(object sender, EventArgs e) {
            try {
                ...
                Response.Redirect("ViewApprovePO.aspx?PoId=" + PoId + "&Redirect=CustomerApprovePONew");
            }
            catch (Exception ex) {
                throw ex;
            }
