<%@ Page Title="" Language="C#" MasterPageFile="~/BiddingAdmin.Master" AutoEventWireup="true" CodeBehind="ViewQuotationTRApprovalNewImports_2.aspx.cs" Inherits="BiddingSystem.ViewQuotationTRApprovalNewImports_2" %>
                                                                                ...
                                                                                <asp:Panel ID="pnlQuotationItems" runat="server" Style="margin-left: 40px; overflow-x: scroll; width: 90%">
                                                                                    <asp:GridView ID="gvQuotationItems" runat="server"
                                                                                        ...
                                                                                        <Columns>
                                                                                            ...
                                                                                            <asp:BoundField DataField="Mill" NullDisplayText="Not Found" HeaderText="Mill"  />
                                                                                            <asp:BoundField DataField="ImpRemark" NullDisplayText="Not Found" HeaderText="Remark" />
                                                                                            <asp:BoundField DataField="ImpHistory" NullDisplayText="Not Found" HeaderText="History" />
                                                                                            <asp:BoundField DataField="ImpValidity" NullDisplayText="Not Found" HeaderText="Validity"  />
