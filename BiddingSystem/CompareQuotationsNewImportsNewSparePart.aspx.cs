...
namespace BiddingSystem {
    public partial class CompareQuotationsNewImportsNewSparePart : System.Web.UI.Page {
        #region Controllers
        ...
        protected void btnPrint_Click(object sender, EventArgs e) {
            ...
            string headerTable = @"<Table><tr><td  colspan='26'><center><h4>Quotation Tabulation For Bid No: B" + bid.BidCode + " </h4></center> </td></tr></Table> <hr>";
            Response.Write(headerTable);
            Response.Charset = "";
            string value = @"<Table><tr><td  colspan='17'></td><td  colspan='4' style= 'border: 0.5px solid black;'><center><b>Requested Values</b></center> </td><td  colspan='4' style= 'border: 0.5px solid black;'><center><b>Selected Values</b></center> </td></tr></Table>";
