<%@ Page Title="" Language="C#" MasterPageFile="~/BiddingAdmin.Master" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="ViewPOReport.aspx.cs" Inherits="BiddingSystem.ViewPOReport" %>
...
<%--                            <ASP:Image id="myImage" Visibile="False" ImgUrl="AdminResources/images/logo.png" runat="server"/>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 col-xs-4">
                                   ...
                                   <%-- <strong>QUOTATION FOR: </strong>
                                    ...
                                    <strong>PURCHASING TYPE: </strong>
                                        <asp:Label runat="server" ID="lblPurchasingType"></asp:Label></br>
                        ...
                        <div class="box-footer no-print">
                            ...
                            <asp:Button runat="server" ID="btnPrint"  Text="Print PO" CssClass="btn btn-success" OnClientClick="printPage()"/>
