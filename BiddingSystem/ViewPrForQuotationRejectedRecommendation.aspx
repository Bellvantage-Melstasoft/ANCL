<%@ Page Title="" Language="C#" MasterPageFile="~/BiddingAdmin.Master" AutoEventWireup="true" CodeBehind="ViewPrForQuotationRejectedRecommendation.aspx.cs" Inherits="BiddingSystem.ViewPrForQuotationRejectedRecommendation" %>
 ...
 <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <%--<li class="active">Tech Committee Approval</li>--%>
          <li class="active">Committee Approval Rejected Bids</li>
      </ol>
    </section> 
    <br />
    ...
    <asp:UpdatePanel ID="Updatepanel1" runat="server">
      ...
      <div class="box box-info" id="panelPurchaseRequset" runat="server">
        <div class="box-header with-border">
          <h3 class="box-title" >Rejected Bids</h3>
