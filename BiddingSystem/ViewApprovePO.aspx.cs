    ...
    public partial class ViewApprovePO : System.Web.UI.Page {
        ...
        protected void Page_Load(object sender, EventArgs e) {
            ...
            if (!IsPostBack) {
                ...
                ddlPaymentMethodForeign.DataValueField = "PaymentModeId";
                ddlPaymentMethodForeign.DataTextField = "PaymentMode";
                ddlPaymentMethodForeign.DataBind();
                ddlPaymentMethodForeign.Items.Insert(0, new System.Web.UI.WebControls.ListItem("Select Payment Type", "0"));
                ...
                txtRemarks.Text = poMaster.Remarks == null ? "No Remark" : poMaster.Remarks;
                ...
                for (int i = 0; i < poMaster.PoDetails.Count; i++) {
                    ...
                    ViewState["PoPurchaseType"] = poMaster.PoDetails[i].PoPurchaseType;
                }
                lblPoPurchaseType.Text = VarPoPurchaseType == 1 ? "Local" : "Import";
                lblAgentName.Text = VarSupplierAgentName;
                ViewState["VarPoPurchaseType"] = VarPoPurchaseType;
        ...
        protected void btnReject_Click(object sender, EventArgs e) {
            ...
            else
            {
                ...
                else if (ddlPaymentMethodForeign.SelectedValue == "")
                {
                    ScriptManager.RegisterClientScriptBlock(Updatepanel1, this.Updatepanel1.GetType(), "none", "<script>    $(document).ready(function () { swal({ type: 'error',title: 'Please Select Payment Method', showConfirmButton: false,timer: 3000}); });   </script>", false);
                    return;
                }
