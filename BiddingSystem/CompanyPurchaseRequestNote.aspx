<%@ Page Title="" Language="C#" MasterPageFile="~/BiddingAdmin.Master" AutoEventWireup="true"
    CodeBehind="CompanyPurchaseRequestNote.aspx.cs" Inherits="BiddingSystem.CompanyPurchaseRequestNote" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentSection" runat="server">
    <style type="text/css">
        ...
        #ContentSection_txtRequiredDate {
            position: relative;
            color: white;
        }
    </style>
    ...
    <form id="form1" runat="server" enctype="multipart/form-data">
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                   ...
                   <div class="form-group">
                    ...
                    <asp:TextBox ID="txtRequiredDate" runat="server"  CssClass="form-control customDate"  onchange="dateChange(this)"   type="date" data-date="" data-date-format="DD MMMM YYYY"  placeholder="Required Date" ></asp:TextBox>
                </div>
            ...
            <%-- <div class="col-md-6">                
               ...
               <div id="divBudget" runat="server">
                <div class="form-group" id='divBudgetRemark' visible="false"  runat="server">
                   ...
                   <asp:TextBox ID="txtBudgetRemark" AutoPostBack="true" TextMode="MultiLine" runat="server"  CssClass="form-control"></asp:TextBox>
                </div>
            ...
            <!-- /.col -->
               ...
               <div class="row">
                ...
                <div class="form-group">
                   ...
                   <asp:TextBox ID="txtMRNReferenceNo"  runat="server" Width="50%"  CssClass="form-control" ></asp:TextBox>
                </div>
     ...
     <div class="box box-danger" id="AddItemsDiv">
        ...
        <div class="box-body">
          <div class="row">
              <div class="col-md-6">
                ...
                <div class="form-group">
                    <label for="exampleInputEmail1">Sub Category</label><label id="lblSubcatergory" runat="server"  Visible="false" style="color:red;"></label>
                 ...
                 <div class="form-group">
                    <label for="exampleInputEmail1">Item Name</label><label id="lblItemCategory" runat="server"  Visible="false" style="color:red;"></label>
                ...
                <div style="display:inline-block;width:60%;" >
                   ...
                   <div  style="display:inline-block;width:35%;"  >
                    ...
                    <asp:RequiredFieldValidator runat="server" ID="RequiredddlMeasurement" ForeColor="Red" Font-Bold="true"  ControlToValidate="ddlMeasurement" InitialValue="0" ValidationGroup="btnAdd"></asp:RequiredFieldValidator>     
                 ...
                 <div class="form-group">
                    <label for="exampleInputEmail1">Item Description</label><label id="lblDescription" runat="server"  Visible="false" style="color:red;"></label>
                     <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator1" ForeColor="Red" Font-Bold="true"  ControlToValidate="txtDescription" ValidationGroup="btnAdd">* Fill This Field</asp:RequiredFieldValidator>    
          ...
          <div class="col-md-12">
              ...
              <div class="col-md-12">
               ...
               <hr />
                  <div class="col-md-6" id="divWarehouse" runat="server" >
                    <div class="form-group">
                        <label>Select Warehouse</label>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" InitialValue="0" ControlToValidate="ddlWarehouse"  ForeColor="Red">*</asp:RequiredFieldValidator>
                        <asp:DropDownList ID="ddlWarehouse" Enabled="false" runat="server" CssClass="form-control"></asp:DropDownList>
                    </div>
                </div>
                   <div class="row"></div>
               <div class="col-md-6">
      ...
      <div class="box box-primary">
        ...
        <div class="form-group">
              <label for="exampleInputEmail1" style="visibility:hidden">Category Name</label>
              <asp:Button ID="btnSavePR"  runat="server" Text="Create Purchase Request"  ValidationGroup="btnSavePR1"  CssClass="btn btn-primary pull-right" OnClick="btnSavePR_Click"></asp:Button>
          </div>
        </div>
        </div>
        </div>
                    ...
                    <div id="specification" class="modal modal-primary fade in" tabindex="-1" role="dialog"
                        aria-hidden="false">
                        <div class="modal-dialog">
                            <!-- Modal content-->
                            <div class="modal-content" style="background-color: #a2bdcc;">
                                ...
                                <div class="modal-body">
                                    <div class="login-3lsw">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="table-responsive">
                                                    <asp:GridView ID="gvSpecificationBoms" runat="server" CssClass="table table-responsive TestTable"
                                                        EmptyDataText="No Specifications Found" Style="border-collapse: collapse; color: black;"
                                                        GridLines="None" AutoGenerateColumns="false">
                                                        <Columns>
                                                            <asp:BoundField DataField="itemId" HeaderText="Item Id" ItemStyle-CssClass="hidden"
                                            ...
                                            <div>
                                                <label id="Label2" style="margin: 3px; color: maroon; text-align: center;">
                                                </label>
                                            </div>
                                        </div>
                                    </div>
    ...
    <script type="text/javascript">
        ...
        function BindToList() {
           // debugger;
            if ($("#<%=ddlMainCateGory.ClientID%>").val() != 0 && $("#<%=ddlSubCategory.ClientID%>").val() != 0 && $("#<%=ddlMeasurement.ClientID%>").val() != 0
                && $("#<%=ddlItemName.ClientID%>").val() != 0 && $("#ContentSection_txtQty").val() != "" && $("#ContentSection_txtDescription").val() != "") {
                ...
                if ($("#<%=ddlMeasurement.ClientID%>").val() == 0) {
                    $("#lblMeasurement").text('*');
                }
