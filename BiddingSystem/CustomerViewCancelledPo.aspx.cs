...
{
    public partial class CustomerViewCancelledPo : System.Web.UI.Page
    {
       ...
       // int DesignationId = 0;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (Session["CompanyId"] != null && Session["UserId"].ToString() != null)
            {
                ...
                ((BiddingAdmin)Page.Master).subTabValue = "CustomerViewCancelledPo.aspx";
                ((BiddingAdmin)Page.Master).subTabId = "CustomerViewCancelledPoLink";
              ...
              //  UserId = Session["UserId"].ToString();
               var companyLogin = companyLoginController.GetUserbyuserId(int.Parse(Session["UserId"].ToString()));
                ...
                if ((!companyUserAccessController.isAvilableAccess(int.Parse(Session["UserId"].ToString()), int.Parse(Session["CompanyId"].ToString()), 6, 28) && companyLogin.Usertype != "S") && companyLogin.Usertype != "GA")
                {
                ...
                if (int.Parse(Session["UserId"].ToString()) != 0)
                {
                    try
                    {
                      ...
                      //// {
                            ...
                            gvPurchaseOrder.DataSource = pOMasterController.ViewCancelledPOS(int.Parse(Session["CompanyId"].ToString()), LocalTime.Now, prCode, poCode, CategoryIds, warehouseIds, poType);
        ...
        protected void btnSearch_Click(object sender, EventArgs e) {
            ...
            try {
                if (chkMonth.Checked || chkPrCode.Checked || chkCategory.Checked || chkWarehouse.Checked || chkPoCode.Checked ) {
                    ...
                    gvPurchaseOrder.DataSource = pOMasterController.ViewCancelledPOS(int.Parse(Session["CompanyId"].ToString()), date, prCode, poCode, CategoryIds, warehouseIds, poType);
                    gvPurchaseOrder.DataBind();
