<%@ Page Title="" Language="C#" MasterPageFile="~/BiddingAdmin.Master" AutoEventWireup="true" CodeBehind="CompanyClosedManualBidsP.aspx.cs" Inherits="BiddingSystem.CompanyClosedManualBidsP" %>
    ...
    <h1>
      ...
      <div class="box box-info" id="panelPurchaseRequset" runat="server">
        <div class="box-header with-border">
          <h3 class="box-title" >Closed Bids</h3>
    ...
    <div class="table-responsive">
        <asp:GridView ID="gvBids" runat="server" CssClass="table table-responsive"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField DataField="ParticipatedSuppliers" HeaderText="Participants" 
                                                            HeaderStyle-HorizontalAlign="Center"
                                                            ItemStyle-HorizontalAlign="Center"/>
