<%@ Page Title="" Language="C#" MasterPageFile="~/BiddingAdmin.Master" AutoEventWireup="true" CodeBehind="AssignStoreKeeperToMRN.aspx.cs" Inherits="BiddingSystem.AssignStoreKeeperToMRN" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentSection" runat="server">
   <%-- <style>
         #ContentSection_gvMrn tbody tr td {
            white-space: nowrap;
            vertical-align: middle;
        }
         table#ContentSection_gvMrn tbody tr td.Department , table#ContentSection_gvMrn tbody tr td.Description {
   ...
   <%-- <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.4.1/jquery.min.js"></script>
    ...
    <link href="AdminResources/css/select2.min.css" rel="stylesheet" />
     ...
     <section class="content-header">
      <h1>
       Assign Store Keeper to MRN
        <small></small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="AdminDashboard.aspx"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Assign Store Keeper to MRN</li>
      </ol>
    </section>
    <br />
                           ...
                           <asp:CheckBox ID="chkPurchaseProcedure" runat="server" data-Control="ddlPurchaseProcedure"></asp:CheckBox>
                            <label for="exampleInputEmail1">Purchase Procedure</label>
                             <asp:DropDownList ID="ddlPurchaseProcedure" runat="server" CssClass="form-control" > 
                                 ...
                                 <asp:ListItem Value="2">Cover</asp:ListItem> 
                             </asp:DropDownList>
                          </div>
                        </div>
                    </div>
                 ...
                 <div class="panel panel-default" id="panelGridview" runat="server">
                   ...
                   <div class="panel-body" style="overflow-x:scroll">
                        <asp:GridView runat="server" ID="gvMrn" GridLines="None"  HeaderStyle-BackColor="#3C8DBC" HeaderStyle-ForeColor="White" CssClass="table table-responsive tablegv" AutoGenerateColumns="false" DataKeyNames="MrnID" EmptyDataText="No records Found"
                            AllowPaging="true"  PageSize="15" OnPageIndexChanging="gvAssignSK_PageIndexChanging">
                             <Columns>
