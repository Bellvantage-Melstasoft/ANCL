<%@ Page Title="" Language="C#" MasterPageFile="~/BiddingAdmin.Master" AutoEventWireup="true" CodeBehind="ViewMyPR.aspx.cs" Inherits="BiddingSystem.ViewMyPR" %>
    ...
    <form runat="server">
        ...
        <asp:UpdatePanel ID="Updatepanel1" runat="server">
            <ContentTemplate>
              ...
              <div id="mdlViewPr" class="modal fade" tabindex="-1" role="dialog" style="z-index: 3000;" aria-hidden="true">
                    <div class="modal-dialog" style="width: 60%;">
                        <div class="modal-content">
                            <div class="modal-header" style="background-color: #3C8DBC; color: white">
                                ...
                                <h4 class="modal-title">PR Log</h4>
                            </div>
                            <div class="modal-body row">   
                                <div class="col-xs-12">
                                        <div> &nbsp</div>
                                        <div style="color: black;">
                                         <asp:GridView ID="gvPrDetails" runat="server" OnRowDataBound="gvPrDetails_RowDataBound"
                                          CssClass="table table-responsive" GridLines="None" AutoGenerateColumns="false" EmptyDataText="No Pr Found" RowStyle-BackColor="#f5f2f2" HeaderStyle-BackColor="#525252" HeaderStyle-ForeColor="White">
                                             <Columns>
                                                <asp:TemplateField HeaderText="Log">
                                                    <ItemTemplate>
                                                        ...
                                                        Text='<%# Eval("LogName").ToString()%>' CssClass="label label-info"/>
                                                            ...
                                                            Text="PR CREATED" CssClass="label label-info"/>
                                                        <asp:Label
                                                            runat="server"
                                                            Visible='<%# Eval("Status").ToString() == "1" ? true : false %>'
                                                            Text="PR MODIFIED" CssClass="label label-warning" />
                                                        <asp:Label
                                                            runat="server"
                                                        ...
                                                        <asp:Label
                                                            ...
                                                            Text="EXPENSE APPROVED" CssClass="label label-success" />
                                                        <asp:Label
                                                            runat="server"
                                                            Visible='<%# Eval("Status").ToString() == "5" ? true : false %>'
                                                            Text="EXPENSE REJECTED"  CssClass="label label-danger"/>
                                                        <asp:Label
                                                            runat="server"
                                                            Visible='<%# Eval("Status").ToString() == "6" ? true : false %>'
                                                            Text="STOCK ISSUED"  CssClass="label label-info"/>
                                                        ...
                                                        <asp:Label
                                                            ...
                                                            Text="STOCK RECEIVED"  CssClass="label label-info"/>
                                                        <asp:Label
                                                            runat="server"
                                                            Visible='<%# Eval("Status").ToString() == "10" ? true : false %>'
                                                            Text="PR CLONED"  CssClass="label label-success"/>
                                                        <asp:Label
                                                            runat="server"
                                                            Visible='<%# Eval("Status").ToString() == "11" ? true : false %>'
                                                            Text="DEPARTMENT STOCK UPDATED"  CssClass="label label-success"/>--%>
                                                                        </ItemTemplate>
                                                                    </asp:TemplateField>
                                                                </Columns>
                                                            </asp:GridView>
                                                ...
                                                <ItemTemplate>
                                                   ...
                                                   <%-- <asp:Label
                                                        ...
                                                        Text="Approval Pending" CssClass="label label-warning"/>
                                                    <asp:Label
                                                        runat="server"
                                                        Visible='<%# Eval("CurrentStatus").ToString() == "1" ? true : false %>'
                                                        Text="PR Modified" CssClass="label label-success"/>
                                                    <asp:Label
                                                        runat="server"
                                                        Visible='<%# Eval("CurrentStatus").ToString() == "2" ? true : false %>'
                                                        Text="PR Approved" CssClass="label label-info"/>
                                                    <asp:Label
                                                        runat="server"
                                                        Visible='<%# Eval("CurrentStatus").ToString() == "3" ? true : false %>'
                                                        Text="PR Rejected" CssClass="label label-success"/>
                                                    <asp:Label
                                                        runat="server"
                                                        Visible='<%# Eval("CurrentStatus").ToString() == "8" ? true : false %>'
                                                        Text="PR Terminated" CssClass="label label-success"/>
                                                    <asp:Label
                                                        runat="server"
                ...
                <section class="content-header">
                    <h1>View My Purchase Request Notes<small></small></h1>
                    <ol class="breadcrumb">
                        <li><a href="AdminDashboard.aspx"><i class="fa fa-dashboard"></i> Home</a></li>
                        <li class="active">View Purchase Request Notes </li>
                    </ol>
                </section>
                <br />
                ...
                <div class="panel panel-default" id="panelPRAdvanceSearch" runat="server">
                   <div class="panel-heading">
                   ...
                   <div class="panel-body collapse" id="advancedSearch">
                    ...
                    <div class="row">
                       <div class="col-md-6">
                        <div class="form-group">
                           <asp:CheckBox ID="chkPrType" runat="server" data-Control="ddlPrType"></asp:CheckBox>
                ...
                <div class="panel panel-default" id="panelGridview" runat="server">
                   ...
                   <div class="panel-body" style="overflow: scroll;max-height: 800px;">
                        <asp:GridView runat="server" ID="gvPr" GridLines="None"  HeaderStyle-BackColor="#3C8DBC" HeaderStyle-ForeColor="White" CssClass="table table-responsive tablegv" AutoGenerateColumns="false" DataKeyNames="PrId" EmptyDataText="No records Found"
                            AllowPaging="true"  PageSize="15" OnPageIndexChanging="gvPr_PageIndexChanging">
                             <Columns>
                                ...
                                <asp:BoundField DataField="CategoryName"  HeaderText="Category Name" ItemStyle-CssClass="Category Name" />
