<%@ Page Title="" Language="C#" MasterPageFile="~/BiddingAdmin.Master" AutoEventWireup="true" CodeBehind="ApproveQuotationsItemWiseImportSparePart.aspx.cs" Inherits="BiddingSystem.ApproveQuotationsItemWiseImportSparePart" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentSection" runat="server" ViewStateMode="Enabled">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Approve Purchase Requests </li>
        </ol>
    </section>
    <br />
                                                            ...
                                                            <table class="table table-striped">
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td id="tdTotal" class="text-right" runat="server">
                                                                    ...
                                                                    <tr>
                                                                        <td><b>VAT</b></td>
                                                                        <td id="tdVAT" class="text-right" runat="server">
                                                                    ...
                                                                    <tr>
                                                                        <td><b>NET TOTAL</b></td>
                                                                        <td id="tdNetTotal" class="text-right" runat="server">
                                                        ...
                                                        <div class="table-responsive">
                                                            <table class="table table-striped">
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        <td><b>TOTAL WITHOUT VAT</b></td>
                                                                        <td id="td1" class="text-right" runat="server">
                                                                    ...
                                                                    <tr>
                                                                        <td><b>VAT</b></td>
                                                                        <td id="td2" class="text-right" runat="server">
                                                                    ...
                                                                    <tr>
                                                                        <td><b>NET TOTAL</b></td>
                                                                        <td id="td4" class="text-right" runat="server">
                                                        ...
                                                        <asp:TemplateField HeaderText="Actions" HeaderStyle-Width="110px" ItemStyle-Width="110px">
                                                            <ItemTemplate>
                                                                <%--<asp:Button CssClass="btn btn-xs btn-primary" runat="server"
                                                                 ...
                                                                 <asp:Button CssClass="btn btn-xs btn-primary" runat="server"
                                                                    ID="Button3" Text="Tabulation Sheet" OnClick="btnViewNew_Click"
                                                                    style="width:120px;"></asp:Button>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                    </Columns>
