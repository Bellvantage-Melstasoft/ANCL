<%@ Page Title="" Language="C#" MasterPageFile="~/BiddingAdmin.Master" AutoEventWireup="true" CodeBehind="ViewApprovePR.aspx.cs" Inherits="BiddingSystem.ViewApprovePR" %>
        ...
        <asp:UpdatePanel ID="Updatepanel1" runat="server">
            <ContentTemplate>
                <section class="content-header">
                    <h1>Approve Purchase Request Notes<small></small></h1>
                    <ol class="breadcrumb">
                        <li><a href="AdminDashboard.aspx"><i class="fa fa-dashboard"></i> Home</a></li>
                        <li class="active">Approve Purchase Request Notes </li>
                    </ol>
                </section>
                <br />
                ...
                <div class="panel panel-default" id="panelGridview" runat="server">
                   ...
                   <div class="panel-body"  style="overflow-x:scroll">
                        <asp:GridView runat="server" ID="gvPr" GridLines="None" CssClass="table table-responsive tablegv" HeaderStyle-BackColor="#3C8DBC" HeaderStyle-ForeColor="White"  AutoGenerateColumns="false" DataKeyNames="PrId" EmptyDataText="No records Found"
                            AllowPaging="true"  PageSize="15" OnPageIndexChanging="gvPr1_PageIndexChanging">
                        <Columns>
