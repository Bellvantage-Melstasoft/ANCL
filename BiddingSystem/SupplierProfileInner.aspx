<%@ Page Title="" Language="C#" MasterPageFile="~/SupplierLoadingWebUIInner.Master" AutoEventWireup="true" CodeBehind="SupplierProfileInner.aspx.cs" Inherits="BiddingSystem.SupplierProfileInner" %>
   ...
   <div class="services-breadcrumb" style="background-color: #005383">
		<div class="agile_inner_breadcrumb">
			<div class="container">
				<ul class="w3_short">
					<li>
						<a href="SupplierInitialFrontViewInner.aspx">Home</a>
						<i style="color:White">|</i>
                        <a href="#" style="color:Yellow">Update Profile</a>
					</li>
				</ul>
			</div>
		</div>
    ...
    <br />
    <h3 class="tittle-w3l">Supplier Profile
    ...
    <div class="modal-dialog">
        ...
        <div style="background-color:White">
         ...
         <div class="col-md-5">
                ...
                <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator4" ForeColor="Red"  InitialValue="Select Location" Font-Bold="true" ControlToValidate="ddlCompanyType" ValidationGroup="btnSave">*</asp:RequiredFieldValidator>     
                ...
                <div class="form-group">
                <label for="exampleInputEmail1"  style="font-weight:bold;display:inline-block">Nature Of Business</label>
                <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator5" ForeColor="Red"  InitialValue="0" Font-Bold="true" ControlToValidate="ddlBusinessCategory" ValidationGroup="btnSave">*</asp:RequiredFieldValidator>     
                <asp:DropDownList ID="DropDownList1" runat="server" CssClass="form-control" >
                </asp:DropDownList> 
                </div>

                <div class="form-group">
                <asp:Label ID="Label2" runat="server" CssClass="control-label" Font-Bold="true">Item Image Upload (Jpg, Jpeg, Png, Gif)</asp:Label>
                <asp:RegularExpressionValidator ID="RegularExpressionValidator4" runat="server"  ControlToValidate="fileUpload1"  ErrorMessage="Jpg, Jpeg, Png, Gif Only" ForeColor="Red"  ValidationExpression="([a-zA-Z0-9\s_\\.\-\)\(x:])+(.png|.jpeg|.jpg|.gif)$" ValidationGroup="btnSave">  </asp:RegularExpressionValidator>
                <div class="input-group margin">
