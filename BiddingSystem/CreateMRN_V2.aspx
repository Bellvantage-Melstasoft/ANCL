<%@ Page Title="" Language="C#" MasterPageFile="~/BiddingAdmin.Master" AutoEventWireup="true" CodeBehind="CreateMRN_V2.aspx.cs" Inherits="BiddingSystem.CreateMRN_V2" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentSection" runat="server">
            ...
            <div class="panel wizard">
                <div class="panel-body">
                    <div class="row">
                        <div class="col-xs-12">
                            <h4>
                                <b>CREATE</b> MATERIAL REQUEST NOTE <br>
                                <hr>
                            </h4>
                        </div>
                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group refreshable">
                                                        ...
                                                        <label class="label label-info pull-right lbl-refresh" onclick="loadDepartments();">Refresh</label>
                                                        <label id="depLoad"  class="label label-info pull-right hidden"><i class="fa fa-spinner fa-spin"></i></label>
                                                        <span
                                                    ...
                                                    <div class="form-group">
                                                        <label>MRN TYPE</label><span class="required basicRequired">
                                                            *</span><br>
                                                        <%--<select id="ddlMRNType" class="form-control select2" onchange="loadItem();">--%>
                                                        <select id="ddlMRNType" class="form-control select2" onchange="MrnTypeOnchange();">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input-group" id="GrCapitalEx">
                                                                    <span class="input-group-addon">
                                                                        <input type="radio" id="rdoCapex"
                                                                            name="expenseType" checked />
                                                                    </span>
                                                                    <input type="text" class="form-control" value="Capital Expense" id="capitalEx" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input-group" id="GrOperationalEx">
                                                                    <span class="input-group-addon">
                                                                        <input type="radio" id="rdoOpex"
                                                                            name="expenseType" />
                                                                    </span>
                                                                    <input type="text" class="form-control" value="Operational Expense" id="OprationalEx" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group refreshable">
                                                        ...
                                                        <span class="required basicRequired">
                                                            *</span>
                                                        <%--<select id="ddlWarehouse" class="form-control select2" onchange="updateMeasurement();">--%>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group refreshable">
                                                        ...
                                                        <span
                                                            class="required basicRequired"> *</span>
                                                        <select id="ddlMRNCategory" class="form-control select2" onchange="loadSubCategory();">
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group refreshable">
                                                        <label>MRN SUBCATEGORY</label>
                                                        ...
                                                        <span
                                                            class="required basicRequired"> *</span>
                                                        <select id="ddlMRNSubCategory" class="form-control select2" onchange="loadItem();">
                                                        </select>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group refreshable">
                                                        ...
                                                        <label id="itemLoad"  class="label label-info pull-right hidden"><i class="fa fa-spinner fa-spin"></i></label>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select id="ddlMeasurement" class="form-control select2"  onchange="changeAvaStock();">
                                                            </select>
                                                    ...
                                                    <div class="form-group">
                                                        <label>AVAILABLE STOCK</label><span
                                                    class="required itemRequired"> *</span>
                                                        <input id="txtDepartmentStock1" type="text" class="form-control" disabled/>
                                                    </div>
                                                     <div class="form-group">
                                                        <label>AVAILABLE DEPARTMENT STOCK</label><span
                                                    class="required itemRequired"> *</span>
                                                        <input id="txtDepartmentStock" type="number" class="form-control" min="0" onkeypress="return event.charCode != 45"/>
                                                    </div>
                                                    <div class="form-group">
                                                   ...
                                                   <div class="hidden" id="dvSparepart">
                                                     <div class="form-group">
    ...
    <script src="ViewModels/JS/MrnViewModel.js?v=<%DateTime.Now.ToString();%>"></script>
    <script src="Scripts/CreateMrn.js?v=<%DateTime.Now.ToString();%>"></script>
</asp:Content>
