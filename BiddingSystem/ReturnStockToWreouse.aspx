<%@ Page Title="" Language="C#" MasterPageFile="~/BiddingAdmin.Master" AutoEventWireup="true" CodeBehind="ReturnStockToWreouse.aspx.cs" Inherits="BiddingSystem.ReturnStockToWreouse" %>
      ...
      <div class="box box-info" id="panelMRN" runat="server">
        ...
        <!-- /.box-body -->
          <div class="box-footer">
                             <asp:Button ID="btnReturnMRN" runat="server" Text="Print" CssClass="btn btn-info" OnClick="btnReturnMRN_Click"></asp:Button>
                              </div>
      </div>
      <!-- /.box -->
        ...
        <!-- /.box-body -->
                         <div class="box-footer">
                             <asp:Button ID="btnPrintDepartmentReturn" runat="server" Text="Print"  CssClass="btn btn-info" OnClick="btnPrintDepartmentReturn_Click"></asp:Button>
                              </div>
      </div>
