<%@ Page Language="C#" MasterPageFile="~/BiddingAdmin.Master" AutoEventWireup="true" CodeBehind="ViewPRNew.aspx.cs" Inherits="BiddingSystem.ViewPRNew" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentSection" runat="server">
        ...
        <div class="modal-dialog">
            ...
            <div class="box box-info">
                    ...
                    <div class="box-footer no-print">
                        ...
                        <asp:Button runat="server" ID="btnModify" CssClass="btn btn-warning" Text="Edit PR" OnClick="btnModify_Click" />
                        <asp:Button runat="server" ID="btnClone" CssClass="btn btn-info" Text="Clone" OnClick="btnClone_Click" />
                        <asp:Button runat="server" ID="btnTerminatePR" CssClass="btn btn-danger" Text="Terminate" OnClientClick="terminatePR(event)" />
    ...
    <script type="text/jscript">
        ...
        function terminatePR(e) {
            e.preventDefault();

            swal.fire({
                title: 'Are you sure?',
                html: "Are you sure you want Terminate this PR?</br></br>"
