...
namespace BiddingSystem {
    public partial class ViewAllPR : System.Web.UI.Page {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (Session["CompanyId"] != null && Session["UserId"].ToString() != null)
            {
                ...
                ((BiddingAdmin)Page.Master).subTabValue = "ViewAllPR.aspx";
                ((BiddingAdmin)Page.Master).subTabId = "viewAllPRLink";
            ...
            if (!IsPostBack)
            {
                ...
                try
                {
                    ...
                    List<PrMasterV2> prList = prControllerV2.FetchAllPrByBasicSearchByMonth(LocalTime.Now);
        ...
        protected void btnBasicSearch_Click(object sender, EventArgs e)
        {
            try {
                ...
                if (rdbMonth.Checked)
                {
                    ...
                    List<PrMasterV2> prList = prControllerV2.FetchAllPrByBasicSearchByMonth(date);
                    gvPr.DataSource = prList;
                    gvPr.DataBind();
                }
                else
                {
                    ...
                    PrMasterV2 pr = prControllerV2.FetchAllPrByBasicSearchByPrCode(txtPrCode.Text);
        ...
        protected void gvPr_PageIndexChanging(object sender, GridViewPageEventArgs e) {
            try {
                ...
                if (ViewState["SearchStatus"].ToString() == "1" && ViewState["SearchStatus"] != null) {
                    ...
                    List<PrMasterV2> prList = prControllerV2.FetchAllPrByAdvanceSearch(
                        DepartmentIds,
                        WareHouseIds,
                        purchaseType,
                        purchaseProcedure,
