<%@ Page Title="" Language="C#" MasterPageFile="~/BiddingAdmin.Master" AutoEventWireup="true" CodeBehind="RecommendQuotationsItemWiseRejectedImportsSparePart.aspx.cs" Inherits="BiddingSystem.RecommendQuotationsItemWiseRejectedImportsSparePart" %>
                                                                    ...
                                                                    <asp:Panel ID="pnlQuotationItems" runat="server" Style="width: 90%; margin-left: 40px; overflow-x: scroll;">
                                                                        <asp:GridView ID="gvRejectedQuotationItems" runat="server"
                                                                            ...
                                                                            <Columns>
                                                                                ...
                                                                                <asp:BoundField DataField="Mill" HeaderText="Mill" NullDisplayText="-" HeaderStyle-CssClass="hidden" ItemStyle-CssClass="hidden"/>
                                                                                ...
                                                                                <asp:BoundField DataField="ImpClearing" HeaderText="Clearing" NullDisplayText="-" HeaderStyle-CssClass="hidden" ItemStyle-CssClass="hidden"/>
                                                                                <asp:BoundField DataField="ImpOther" HeaderText="Other" NullDisplayText="-" HeaderStyle-CssClass="hidden" ItemStyle-CssClass="hidden"/>
                                                                                <asp:BoundField DataField="ImpHistory" HeaderText="History" NullDisplayText="-" HeaderStyle-CssClass="hidden" ItemStyle-CssClass="hidden"/>
                                                                                <asp:BoundField DataField="ImpEstDelivery" HeaderText="Est Delivery" NullDisplayText="-" />
                                                                                <asp:BoundField DataField="ImpValidity" HeaderText="Validity" NullDisplayText="-" HeaderStyle-CssClass="hidden" ItemStyle-CssClass="hidden"/>
                                                            ...
                                                            <ItemTemplate>
                                                               <%-- <asp:Button CssClass="btn btn-xs btn-danger" runat="server"
                                                                ...
                                                                <asp:Button CssClass="btn btn-xs btn-warning Margin"  runat="server" Visible='<%#Eval("Visible").ToString()== "1"?true:false %>'
                                                                    ID="Button4" Text="Clone Bid" OnClientClick='<%#"Clone(event,"+Eval("BidId").ToString()+")" %>' 
                                                                    style="width:100px;"></asp:Button>
                                                                <asp:Button CssClass="btn btn-xs btn-danger Margin" runat="server" Visible='<%#Eval("Visible").ToString()== "1"?true:false %>'
                                                                    ID="Button5" Text="Terminate" OnClientClick='<%#"Terminate(event,"+Eval("BidId").ToString()+")" %>'
                                                                    style="width:100px;"></asp:Button>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                    </Columns>
