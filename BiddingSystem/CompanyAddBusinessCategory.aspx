<%@ Page Title="" Language="C#" MasterPageFile="~/BiddingSuperAdmin.Master" AutoEventWireup="true" CodeBehind="CompanyAddBusinessCategory.aspx.cs" Inherits="BiddingSystem.CompanyAddBusinessCategory" %>
...
<section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Add Business Category</li>
      </ol>
    </section>
    <br /> 
    <style type="text/css">
...
<form id="form1" runat="server">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button id="btnNoConfirmYesNo" onclick="return hideModal();" type="button" class="btn btn-danger" >No</button>
            </div>
        </div>
    </div>
</div>
    ...
    <asp:HiddenField  ID="hdnBusinessCategoryId" runat="server"/>
...
<asp:HiddenField  ID="HiddenField1" runat="server"/>
        ...
        <div class="box-body">
          <div class="row">
            ...
            <div class="col-md-6">
                ...
                <label for="exampleInputEmail1">Business Category Name</label>
                 <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtBusinessCategoryName" ValidationGroup="btnSave" ForeColor="Red">*</asp:RequiredFieldValidator>
                 <asp:TextBox ID="txtBusinessCategoryName" runat="server" CssClass="form-control" autocomplete="off"></asp:TextBox>
                </div>
                </div>
                <div class="col-md-6">
                <div class="form-group">
    ...
    <div class="table-responsive">
       <asp:GridView ID="gvMainCategory" runat="server" CssClass="table table-responsive tablegv" GridLines="None"  EmptyDataText="No Business Categories Found" AutoGenerateColumns="false" PageSize="10" AllowPaging="true" OnPageIndexChanging="gvMainCategory_PageIndexChanging">
        <Columns>
             <asp:TemplateField HeaderText="Business Category Id" ItemStyle-CssClass="hidden" HeaderStyle-CssClass="hidden">
             <ItemTemplate>
                 <asp:Label Text='<%#Eval("BusinessCategoryId").ToString()%>' ID="updatedBy" runat="server"></asp:Label>
             </ItemTemplate>
         </asp:TemplateField>
            <asp:BoundField DataField="BusinessCategoryId" HeaderText="Business Category Id" HeaderStyle-CssClass="hidden" ItemStyle-CssClass="hidden"/>
            <asp:BoundField DataField="BusinessCategoryName" HeaderText="Business Category Name" />
             ...
             <ItemTemplate>
              ...
              <asp:TemplateField HeaderText="Edit">
                ...
                <asp:TemplateField HeaderText="Delete">
                  <ItemTemplate>
                      <asp:ImageButton ID="btnCancelRequest" ImageUrl='<%#Eval("IsActive").ToString()== "1"?"~/images/delete.png":"~/images/dlt.png" %>' Enabled='<%#Eval("IsActive").ToString()== "1"?true:false %>'  ToolTip='<%#Eval("IsActive").ToString()== "1"?"Delete":"Deleted" %>' CssClass="deleteBusinessCategory"  style="width:26px;height:20px;"
                          runat="server" />
                  </ItemTemplate>
                </asp:TemplateField>
        </Columns>
    ...
    <script type="text/javascript">
        ...
        {
            $("#<%=hdnBusinessCategoryId.ClientID%>").val()
            var $confirm = $("#modalDeleteYesNo");
            $confirm.modal('show');
            return this.false;
        }
    ...
    <script>
        ...
        Sys.Application.add_load(function() {
            ...
            $(".deleteBusinessCategory").click(function () {
                var businessCatecoryID = $(this).parent().prev().prev().prev().prev().prev().prev().prev().prev().prev().prev().children().html();
                $("#<%=hdnBusinessCategoryId.ClientID%>").val(businessCatecoryID);
                showDeleteModal();
            });
        });
    </script>
