<%@ Page Title="" Language="C#" MasterPageFile="~/BiddingAdmin.Master" AutoEventWireup="true" CodeBehind="ViewMyMrn.aspx.cs" Inherits="BiddingSystem.ViewMyMrn" %>
        ...
        <asp:UpdatePanel ID="Updatepanel1" runat="server">
            <ContentTemplate>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="Current Status">
                                                                        <ItemTemplate>
                                                                            ...
                                                                            <%--<asp:Label
                                                                                ...
                                                                                Text="MRN MODIFIED" CssClass="label label-success" />
                                                                            <asp:Label
                                                                                runat="server"
                                                                            ...
                                                                            <asp:Label
                                                                                ...
                                                                                Text="STOCK ISSUED"  CssClass="label label-success"/>
                                                                            <asp:Label
                                                                                runat="server"
                                                                             ...
                                                                             <asp:Label
                                                                                ...
                                                                                Text="CLONED" CssClass="label label-success" />
                                                                             <asp:Label
                                                                                runat="server"
                                                                                Visible='<%# Eval("Status").ToString() == "11" ? true : false %>'
                                                                                Text="EXPENSE UPDATED" CssClass="label label-info" />--%>
                                                                        </ItemTemplate>
                                                                    </asp:TemplateField>
                                                                </Columns>
                                                            </asp:GridView>
                ...
                <section class="content-header">
                    <h1>View My Material Request Notes<small></small></h1>
                    <ol class="breadcrumb">
                ...
                <section class="content">
                    ...
                    <div class="panel panel-default" id="panelGridview" runat="server">
                        ...
                        <div class="panel-body" style="overflow-x: scroll">
                            <asp:GridView runat="server" ID="gvMrn" GridLines="None" HeaderStyle-BackColor="#3C8DBC" HeaderStyle-ForeColor="White" CssClass="table table-responsive tablegv" AutoGenerateColumns="false" DataKeyNames="MrnID" EmptyDataText="No records Found"
                                AllowPaging="true" PageSize="15" OnPageIndexChanging="gvMrn_PageIndexChanging">
                                <Columns>
