<%@ Page Title="" Language="C#" MasterPageFile="~/BiddingAdmin.Master" AutoEventWireup="true" CodeBehind="ViewPrForQuotationRecommendation.aspx.cs" Inherits="BiddingSystem.ViewPrForQuotationRecommendation" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentSection" runat="server">
      <script src="AdminResources/js/jquery.min.js" type="text/javascript"></script>
 <section class="content-header">
      <h1>
       Recommendation Committee Approval
        <small></small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="AdminDashboard.aspx"><i class="fa fa-home"></i> Home</a></li>
        <%--<li class="active">Tech Committee Approval</li>--%>
          <li class="active">Committee Approval</li>
      </ol>
    </section> 
    <br />
            ...
            <div class="table-responsive">
                <asp:GridView runat="server" ID="gvPurchaseRequest" GridLines="None" CssClass="table table-responsive" HeaderStyle-BackColor="#3C8DBC" HeaderStyle-ForeColor="White"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="ExpectedDate"  HeaderText="Date Of Request" dataformatstring="{0:dd MMMM yy}" />
                        ...
                        <asp:BoundField DataField="CreatedDateTime"  HeaderText="PR Created Date"  dataformatstring="{0:dd MMMM yy}"/>
                        ...
                        <asp:BoundField DataField="PrIsApprovedOeRejectDate"  HeaderText="PrIsApprovedOeRejectDate" HeaderStyle-CssClass="hidden" ItemStyle-CssClass="hidden"/>
                         <asp:BoundField DataField="PurchaseType"
                                                        HeaderText="PurchaseType" HeaderStyle-CssClass="hidden"
