<%@ Page Title="" Language="C#" MasterPageFile="~/BiddingAdmin.Master" AutoEventWireup="true" CodeBehind="ManualBidSubmissionNew.aspx.cs" Inherits="BiddingSystem.ManualBidSubmissionNew" %>
                                            ...
                                            <Columns>
                                               ...
                                               <%-- <asp:BoundField DataField="ItemId" HeaderText="Item Id"
                                                ...
                                                <asp:TemplateField HeaderText="HS ID">
                                                    <ItemTemplate>
                                                        <asp:TextBox  ID="txtHSID" Text="" CssClass="txtHSID form-control" Enabled="false"
                                                ...
                                                <asp:TemplateField HeaderText="Brand">
                                                 ...
                                                 <asp:TemplateField HeaderText="MILL">
                                                    <ItemTemplate>
                                                        <asp:TextBox  ID="txtMill" Text="" CssClass="txtMill form-control" 
                                                ...
                                                <asp:TemplateField HeaderText="CIF">
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="txtCif" Text='<%#Eval("CIF")%>'
                                                             Enabled="false" type="number"  step="any" min="0" runat="server" Width="180px" DataFormatString="{0:N2}"
                                                ...
                                                <asp:TemplateField HeaderText="Duty & PAL">
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="txtdutypal" Text='<%#Eval("Duty&pal")%>'
                                                             runat="server" Width="180px" Enabled="false"
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="txtUnitPrice" Text='<%#Eval("UnitPrice")%>'
                                                         ...
                                                         <%--<asp:TextBox ID="txtUnitPrice" Text='<%#Eval("UnitPrice")%>' 
                                                            runat="server" Width="180px" CssClass="txtUnitPriceCl form-control"  />--%>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                ...
                                                <asp:TemplateField HeaderText="History">
                                                    <ItemTemplate>
                                                        <asp:DropDownList ID="ddlHistory" runat="server" CssClass="form-control ddlHistory" AutoPostBack="true" width="100px"  >
                                                        </asp:DropDownList>
                                                ...
                                                <asp:TemplateField HeaderText="Validity">
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="txtvalidity" Text='<%#Eval("Validity")%>' type="date" data-date="" data-date-format="DD MMMM YYYY" CssClass="validity form-control" runat="server" Width="140px" />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
    ...
    <script type="text/javascript">
        ...
        Sys.Application.add_load(function () {
            ...
            $(function () {
                ...
                $('#lblVatTotal').html($('#ContentSection_hdnVatTotal').val().replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,"));
                $('#lblNetTotal').html($('#ContentSection_hdnNetTotal').val().replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,"));
        ...
        Sys.Application.add_load(function () {
            ...
            $('.cltxtCif').change(function (ev) {
                ...
                if (term == "9" || term == "8") {
                    ...
                    $('#ContentSection_gvBidItems tr').eq(1).find('td').eq(20).find('input').val((CIF * 1.01).toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,"));
                ...
                //else if (term == "CIF") {
                    ...
                    $('#ContentSection_gvBidItems tr').eq(1).find('td').eq(20).find('input').val((CIF * 1).toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,"));
            ...
            $('#btnadd').click(function (ev) {
                ...
                $('#ContentSection_gvBidItems tr').eq(1).find('td').eq(21).find('input').val(value.toFixed(2)); 
