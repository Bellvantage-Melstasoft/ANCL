<%@ Page Title="" Language="C#" MasterPageFile="~/BiddingAdmin.Master" AutoEventWireup="true" CodeBehind="ApproveQuotationsNew.aspx.cs" Inherits="BiddingSystem.ApproveQuotationsNew" %>
                                            ...
                                            <asp:Panel ID="Panel2" runat="server">
                                                <asp:GridView ID="gvApproval" runat="server" CssClass="ChildGrid" Width="100%"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField DataField="ApprovedByName" HeaderText="Recommended By" NullDisplayText="-" />
