<%@ Page Title="" Language="C#" MasterPageFile="~/BiddingAdmin.Master" AutoEventWireup="true" CodeBehind="ViewQuotationTRApprovalNewImportsSparePart.aspx.cs" Inherits="BiddingSystem.ViewQuotationTRApprovalNewImportsSparePart" %>
                        ...
                        <div class="modal-content">
                                            ...
                                            <asp:GridView ID="gvRatss" runat="server" CssClass="table table-responsive"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="BidId" HeaderText="BidId"
                                                        HeaderStyle-CssClass="hidden" ItemStyle-CssClass="hidden" />
                                                    <asp:BoundField DataField="CurrencyTypeId" HeaderText="CurrencyTypeId"
                                                        HeaderStyle-CssClass="hidden" ItemStyle-CssClass="hidden" />

                                                    <asp:BoundField DataField="CurrencyName" HeaderText="Currency" NullDisplayText="Unavailable" />

                                                    <asp:TemplateField HeaderText="Rate" HeaderStyle-Width="110px" ItemStyle-Width="110px">
                                                        <ItemTemplate>
                                                            <asp:TextBox ID="txtRate" CssClass="txtRate" runat="server" Text='<%# Eval("SellingRate").ToString() %>'></asp:TextBox>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                            ...
                            <div class="box-footer">
                                ...
                                <asp:Button CssClass="btn btn-info btn-styled   pull-right" runat="server"
                                    ID="btnDoneRate" Text="Done" Style="width: 100px;" OnClick="btnDoneRate_Click" OnClientClick="RemoveBackdrop_mdlRates();"></asp:Button>
                            </div>
                        </div>
                        <!-- End : Modal Content -->
                    </div>
                            ...
                            <div class="tab-content">
                                <div id="ItemWise" class="tab-pane fade active in">
                                    <div class="panel panel-default">
                                                        ...
                                                        <asp:GridView ID="gvItems" runat="server"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField>
                                                                    <ItemTemplate>
                                                                        ...
                                                                        <tr style="color: White; background-color: #3C8DBC;">
                                                                            ...
                                                                            <td scope="col">SparePartNumber </td>
                                                                ...
                                                                <asp:BoundField DataField="SupplierMentionedItemName" NullDisplayText="Not Found"
                                                                    HeaderText="Supplier Mentioned Name" HeaderStyle-CssClass="hidden" ItemStyle-CssClass="hidden" />
                                                                                ...
                                                                                <asp:Panel ID="pnlQuotationItems" runat="server" Style="margin-left: 40px; overflow-x: scroll; width: 90%">
                                                                                    <asp:GridView ID="gvQuotationItems" runat="server"
                                                                                        ...
                                                                                        <Columns>
                                                                                            ...
                                                                                            <asp:BoundField DataField="SupplierMentionedItemName" NullDisplayText="Not Found" HeaderText="Supplier Mentioned Name" HeaderStyle-CssClass="hidden" ItemStyle-CssClass="hidden" />
                                                                                            <asp:BoundField DataField="SupplierAgent" NullDisplayText="Not Found" HeaderText="Supplier Agent" />
                                                                                            <asp:BoundField DataField="Country" NullDisplayText="Not Found" HeaderText="Country" />
                                                                                            <%--<asp:BoundField DataField="CurrencyType" NullDisplayText="Not Found" HeaderText="Currency Type" />--%>
                                                                                            <asp:TemplateField HeaderText="Currency Type">
                                                                                            <ItemTemplate>
                                                                                                <asp:Label runat="server" Text='<%# Eval("TermName").ToString() == "Local" ? "LKR" :Eval("CurrencyType") %>' />
                                                                                            </ItemTemplate>
                                                                                        </asp:TemplateField>
                                                                                            <asp:BoundField DataField="ImpBrand" NullDisplayText="Not Found" HeaderText="Brand" />
                                                                                            <asp:BoundField DataField="Mill" NullDisplayText="Not Found" HeaderText="Mill" HeaderStyle-CssClass="hidden" ItemStyle-CssClass="hidden"/>
                                                                                            <asp:BoundField DataField="ImpRemark" NullDisplayText="Not Found" HeaderText="Remark" />
                                                                                            <asp:BoundField DataField="ImpHistory" NullDisplayText="Not Found" HeaderText="History" HeaderStyle-CssClass="hidden" ItemStyle-CssClass="hidden"/>
                                                                                            <asp:BoundField DataField="ImpValidity" NullDisplayText="Not Found" HeaderText="Validity" HeaderStyle-CssClass="hidden" ItemStyle-CssClass="hidden"/>
                                                                                            <asp:BoundField DataField="ImpEstDelivery" NullDisplayText="Not Found" HeaderText="Est Delivery" />
                                                                                            <%--<asp:BoundField DataField="ImpClearing" NullDisplayText="Not Found" HeaderText="Clearing Cost" HeaderStyle-CssClass="hidden" ItemStyle-CssClass="hidden" />
                                                                                            <asp:BoundField DataField="ImpOther" NullDisplayText="Not Found" HeaderText="Other Cost" HeaderStyle-CssClass="hidden" ItemStyle-CssClass="hidden"/>--%>
                                                                                            <%--<asp:BoundField DataField="SparePartNumber" NullDisplayText="Not Found" HeaderText="Spare Part Number" />--%>
                                                                                            <asp:BoundField DataField="TermName" NullDisplayText="Not Found" HeaderText="Term" />
                                                                                            ...
                                                                                            <asp:BoundField DataField="VatAmount" HeaderText="VAT" DataFormatString="{0:N2}" HeaderStyle-CssClass="hidden" ItemStyle-CssClass="hidden"/>
                                                                                            ...
                                                                                            <%--<asp:BoundField DataField="SpecComply" HeaderText="Complies Specs" />--%>
                                                                                             ...
                                                                                             <asp:TemplateField HeaderText="Payment Type" HeaderStyle-Width="130px" ItemStyle-Width="130px">
                                                                                                <ItemTemplate>
                                                                                                    <asp:Label runat="server" Text='<%# Eval("PaymentModeId").ToString() == "1" ? "Advance" : Eval("PaymentModeId").ToString() == "2" ? "On Arrival" : Eval("PaymentModeId").ToString() == "3" ? "LC at sight" : Eval("PaymentModeId").ToString() == "4" ? "L/C usance" : Eval("PaymentModeId").ToString() == "5" ? "D/A" : Eval("PaymentModeId").ToString() == "6" ? "D/P" : "0" %>' />
                                                                                                </ItemTemplate>
                                                                                            </asp:TemplateField>
                                        ...
                                        <div class="box-footer">
                                            ...
                                            <asp:Button CssClass="btn btn-info btn-styled pull-right" runat="server" ID="Button1" Text="Back" Style="width: 100px;" OnClientClick="CloseModelQuotations();"></asp:Button>
                                ...
                                <div id="SupplierWise" class="tab-pane fade">
                                                                            ...
                                                                            <asp:Panel ID="pnlSupplier" runat="server" Style="margin-left: 40px; overflow-x: scroll; width: 90%">
                                                                                <asp:GridView ID="gvItemSupllier" runat="server"
                                                                                    ...
                                                                                    <Columns>
                                                                                        ...
                                                                                        <asp:BoundField DataField="SupplierMentionedItemName" NullDisplayText="Not Found" HeaderStyle-CssClass="hidden" ItemStyle-CssClass="hidden"
                                                                                        ...
                                                                                        <asp:BoundField DataField="SubTotal_Sup" HeaderText="Sub-Total" DataFormatString="{0:N2}" />
                                                                                        <asp:BoundField DataField="Nbt_sup" HeaderText="NBT" DataFormatString="{0:N2}" HeaderStyle-CssClass="hidden" ItemStyle-CssClass="hidden" />
                                                                                        <asp:BoundField DataField="vat_sup" HeaderText="VAT" DataFormatString="{0:N2}" HeaderStyle-CssClass="hidden" ItemStyle-CssClass="hidden"/>
                                                                                        <asp:BoundField DataField="NetTotal_sup" HeaderText="Net-Total" DataFormatString="{0:N2}" />
                                                                                        <%--<asp:BoundField DataField="SpecComply" HeaderText="Complies Specs" />--%>
                                                                                        <asp:BoundField DataField="PaymentModeId" NullDisplayText="Not Found" HeaderText="Payment Type"  HeaderStyle-CssClass="hidden" ItemStyle-CssClass="hidden"/>
                                                                                             <asp:TemplateField HeaderText="Payment Type" HeaderStyle-Width="130px" ItemStyle-Width="130px">
                                    ...
                                    <div class="box-footer">
                                        ...
                                        <asp:Button CssClass="btn btn-info btn-styled pull-right" runat="server" ID="Button2" Text="Back" Style="width: 100px;" OnClientClick="CloseModelQuotations();"></asp:Button>
                    ...
                    <div class="modal-dialog" style="width: 60%;">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="box-footer">
                                ...
                                <asp:Button CssClass="btn btn-info btn-styled pull-right" runat="server" ID="Button3" Text="Close" Style="width: 100px;" OnClientClick="ClosemdlItems();"></asp:Button>
                    ...
                    <div class="modal-dialog">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="box-footer">
                                ...
                                <asp:Button CssClass="btn btn-info btn-styled pull-right" runat="server" ID="Button4" Text="Close" Style="width: 100px;" OnClientClick="ClosemdlAttachments();"></asp:Button>
                                                        ...
                                                        <%--<asp:TemplateField HeaderText="Is Tabulaation Selected">
                                                         ...
                                                         <asp:TemplateField HeaderText="Actions" HeaderStyle-Width="110px" ItemStyle-Width="110px">
                                                            <ItemTemplate>
                                                                ...
                                                                <asp:Button CssClass="btn btn-info btn-styled btn-xs btn-warning" runat="server" 
                                                                    ID="btnReject" Text="Reopen Bid" Enabled='<%# Convert.ToInt32(Eval("Visibility")) == 1 ? true : false %>'
                                                                    style="width:100px;" OnClientClick='<%#"ReOpenBid(event,"+Eval("BidId").ToString()+")" %>' ></asp:Button>

                                                                <%--<asp:Button CssClass="btn btn-info btn-styled btn-xs btn-warning" runat="server" 
                                                                    ID="Button5" Text="Save" 
                                                                    style="width:100px;" OnClick="Save"></asp:Button>--%>
                                                        ...
                                                        <asp:TemplateField HeaderText="Actions" HeaderStyle-Width="110px" ItemStyle-Width="110px">
                                                            <ItemTemplate>
                                                               <%-- <asp:Label
                                                                ...
                                                                <asp:Button CssClass="btn btn-info btn-styled btn-xs btn-info" runat="server" 
                                                                    ID="btnConfirmRates" Text="Confirm Rates"  style="width:100px;" OnClick="btnConfirmRates_Click" ></asp:Button>
...
<%--                                    <asp:Button ID="btnApprove" runat="server" CssClass="btn btn-info btn-styled pull-right"  style="margin-right:10px" Text="Approve" OnClick="btnApprove_Click"/>--%>
                ...
                <asp:Button ID="btnProceed" runat="server" OnClick="lbtnApprove_Click" CssClass="hidden" />
                <asp:Button ID="btnReopen" runat="server" OnClick="btnReopen_Click" CssClass="hidden" />
    ...
    <script type="text/javascript">
        ...
        function RemoveBackdrop_mdlRates() {
        ...
        function TabulationApprove(e, bidId) {
            ...
            swal.fire({
                title: 'Are you sure?',
                html: "Are you sure you want to <strong>Proceed</strong> the bid?</br></br>",
                type: 'warning',
                ...
                if (result.value) {
                    ...
                    $('#ContentSection_btnProceed').click();
           ...
           $('#ContentSection_hdnBidId').val(bidId);
            ...
            swal.fire({
                ...
                if (result.value) {
                  ...
                  $('#ContentSection_btnReopen').click();
