<%@ Page Title="" Language="C#" MasterPageFile="~/SupplierLoadingWebUIInner.Master" AutoEventWireup="true" CodeBehind="SupplierAboutUsInner.aspx.cs" Inherits="BiddingSystem.SupplierAboutUsInner" %>
...
<div class="services-breadcrumb">
    ...
    <div class="welcome">
		<div class="container">
			<!-- tittle heading -->
			<h3 class="tittle-w3l">Welcome to our Online Bidding Portal
			...
			<div class="w3l-welcome-info">
				<div class="col-sm-6 col-xs-6 welcome-grids">
					<div class="welcome-img">
						<img src="SupplierUIResources/images/about.jpg" class="img-responsive zoom-img" alt="">
					</div>
				</div>
				<div class="col-sm-6 col-xs-6 welcome-grids">
					<div class="welcome-img">
						<img src="SupplierUIResources/images/about2.jpg" class="img-responsive zoom-img" alt="">
					</div>
				</div>
			...
			<div class="about-tp">
				...
				<div class="col-md-4 about-agileits-w3layouts-right">
					<div class="img-video-about">
						<img src="SupplierUIResources/images/videoimg2.png" alt="">
					</div>
