<%@ Page Title="" Language="C#" MasterPageFile="~/BiddingAdmin.Master" AutoEventWireup="true" CodeBehind="ViewAllPurchaseRequestsEdit.aspx.cs" Inherits="BiddingSystem.ViewAllPurchaseRequestsEdit" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentSection" runat="server">
    ...
    <section class="content-header">
        <h1>
            View / Edit Purchase Requests
            <small></small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="AdminDashboard.aspx"><i class="fa fa-home"></i> Home</a></li>
            <li class="active"> View Purchase Requests </li>
        </ol>
    </section>
    <br />
                                    ...
                                    <div class="table-responsive">
                                        <asp:GridView runat="server" ID="gvPurchaseRequest"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="DateOfRequest" HeaderText="Expected Date"
                                                     DataFormatString='<%$ appSettings:dateTimePattern %>' />
