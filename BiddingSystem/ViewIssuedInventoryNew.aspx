<%@ Page Title="" Language="C#" MasterPageFile="~/BiddingAdmin.Master" AutoEventWireup="true" CodeBehind="ViewIssuedInventoryNew.aspx.cs" Inherits="BiddingSystem.ViewIssuedInventoryNew" %>
...
<section class="content-header">
    ...
    <asp:UpdatePanel ID="Updatepanel1" runat="server">
          ...
          <div class="row">
            ...
            <div class="table-responsive">
              <asp:GridView runat="server" ID="gvReceivedInventory" GridLines="None" HeaderStyle-BackColor="#3C8DBC" HeaderStyle-ForeColor="White"
                  CssClass="table table-responsive" AutoGenerateColumns="false" EmptyDataText="No records Found">
                    <Columns>
      ...
      <!-- SELECT2 EXAMPLE -->
      <div class="box box-info" id="panelMRN" visible="false" runat="server">
        <div class="box-header with-border">
          ...
          <div class="row">
            ...
            <div class="table-responsive">
              ...
              <asp:GridView runat="server" ID="gvDeliveredInventory" GridLines="None" HeaderStyle-BackColor="#3C8DBC" HeaderStyle-ForeColor="White"
                  CssClass="table table-responsive" AutoGenerateColumns="false" DataKeyNames="MrndInID" EmptyDataText="No records Found">
                    <Columns>
                        <asp:BoundField DataField="MrndInID"  HeaderText="MRNDIN ID" HeaderStyle-CssClass="hidden" ItemStyle-CssClass="hidden"/>
                        <asp:BoundField DataField="MrndID"  HeaderText="MRND ID" HeaderStyle-CssClass="hidden" ItemStyle-CssClass="hidden"/>
