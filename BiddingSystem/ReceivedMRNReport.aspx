<%@ Page Title="" Language="C#" MasterPageFile="~/BiddingAdmin.Master" AutoEventWireup="true" CodeBehind="ReceivedMRNReport.aspx.cs" Inherits="BiddingSystem.ReceivedMRNReport" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentSection" runat="server">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Receive Notes</li>
        </ol>
    </section>
    <br />
            ...
            <asp:UpdatePanel ID="Updatepanel1" runat="server">
                <ContentTemplate>
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator6" ForeColor="Red" Font-Bold="true" ControlToValidate="ddlDepartment" ValidationGroup="btnSearch">*</asp:RequiredFieldValidator>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Select Warehouses</label>
                                        <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator1" ForeColor="Red" Font-Bold="true" ControlToValidate="ddlWarehouses" ValidationGroup="btnSearch">*</asp:RequiredFieldValidator>
                                        <asp:ListBox ID="ddlWarehouses" SelectionMode="Multiple" runat="server" CssClass="select2 form-control" Style="color: black; width: 100%"></asp:ListBox>
                                    </div>
                                </div>
                    ...
                    <asp:Panel runat="server" class="print-count">
                        <div class="row">
                            <div class="col-md-12">
                                <asp:Label ID="Label1" Text="MRN Received Note Report" runat="server" Font-Size="20px"></asp:Label></b></td>
                            </div>
                        </div>
                        <table>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>:&nbsp;</td>
                                <td><b>
                                    <asp:Label ID="lblWarehouses" runat="server" Text=""></asp:Label></b></td>
                            </tr>
                    ...
                    <div class="box box-info">
                        ...
                        <div class="box-body">
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField>
                                                    <ItemTemplate>
                                                        ...
                                                        <asp:Panel ID="pnlMRNBatchDetails" runat="server" Style="display: none" caption="Issue Note Inventory Batches">
                                                            <asp:GridView ID="gvMRNBatchDetails" runat="server" AutoGenerateColumns="false" Caption="Issue Note Inventory Batches"
                                                                CssClass="ChildGrid" Width="100%" EmptyDataText="No records Found">
                                                                <Columns>
                                                                    ...
                                                                    <asp:BoundField DataField="IssuedQty" HeaderText="Received Qty" DataFormatString="{0:N2}" />
                                                                    <asp:BoundField DataField="IssuedStockValue" HeaderText="Received Stock Value" DataFormatString="{0:N2}" />
                                                ...
                                                <asp:BoundField DataField="SubDepartmentName" HeaderText="SubDepartment ReceivedMRNReportName" />
                                                ...
                                                <asp:BoundField DataField="StValue" HeaderText="Stock Value" NullDisplayText="Not Found" DataFormatString="{0:N2}" />
                            ...
                            <div class="row">
                                <div class="col-xs-12 value  text-right">
