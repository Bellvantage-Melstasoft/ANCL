<%@ Page Title="" Language="C#" MasterPageFile="~/BiddingAdmin.Master" AutoEventWireup="true"
    CodeBehind="CustomerViewPurchaseRequisition.aspx.cs" Inherits="BiddingSystem.CustomerViewPurchaseRequisition" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentSection" runat="server">

        <link href="AdminResources/css/daterangepicker.css" rel="stylesheet" type="text/css" />
        <link rel="stylesheet" href="../../bower_components/bootstrap-daterangepicker/daterangepicker.css">
        <link href="AdminResources/css/bootstrap-datetimepicker.min.css" rel="stylesheet"
            type="text/css" />
                ...
                <div class="modal-content" style="background-color: #a2bdcc;">
                    <div class="modal-header" style="background-color: #7bd47dfa;">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close" style="opacity: 1;">
                            <span aria-hidden="true" style="opacity: 1; color: white;">×</span></button>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="table-responsive">
                                        <asp:GridView ID="gvUploadFiles" runat="server" CssClass="table table-responsive TestTable"
                                            Style="border-collapse: collapse; color: black;" GridLines="None" AutoGenerateColumns="false">
                                            <Columns>
                                                <asp:BoundField DataField="ItemId" HeaderText="Item Id" HeaderStyle-CssClass="hidden"
                                                    ItemStyle-CssClass="hidden" />
                                                <asp:BoundField DataField="PrId" HeaderText="PR Id" HeaderStyle-CssClass="hidden"
                                                    ItemStyle-CssClass="hidden" />
                                                <asp:BoundField DataField="FilePath" HeaderText="File Path" HeaderStyle-CssClass="hidden"
                                                    ItemStyle-CssClass="hidden" />
                                                <asp:BoundField DataField="FileName" HeaderText="File Name" />
                                                <asp:TemplateField HeaderText="View">
                                                    <ItemTemplate>
                                                        <asp:ImageButton ID="btnEdit" ImageUrl="~/images/view-icon-614x460.png" Style="width: 39px;
                                                            height: 26px" runat="server" />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="Download">
                                                    <ItemTemplate>
                                                        <asp:ImageButton ID="btnCancelRequest" ImageUrl="~/images/Downloads2.png" Style="width: 26px;
                                                            height: 20px; margin-top: 4px;" runat="server" />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            </Columns>
                                        </asp:GridView>
                    ...
                    <div class="modal-body">
                        <div class="login-w3ls">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="table-responsive">
                                        <asp:GridView ID="gvBOMDate" runat="server" CssClass="table table-responsive TestTable"
                                            Style="border-collapse: collapse; color: black;" GridLines="None" AutoGenerateColumns="false"
                                            EmptyDataText="No Specifications Found">
                                            <Columns>
                                                <asp:BoundField DataField="PrId" HeaderText="PR Id" HeaderStyle-CssClass="hidden"
                                                    ItemStyle-CssClass="hidden" />
                                                <asp:BoundField DataField="ItemId" HeaderText="Item Id" HeaderStyle-CssClass="hidden"
                                ...
                                <div>
                                    <label id="Label1" style="margin: 3px; color: maroon; text-align: center;">
                                    </label>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-md-12">
                                    <div class="table-responsive">
                                        <asp:GridView ID="gvUploadedPhotos" runat="server" CssClass="table table-responsive TestTable"
                                            Style="border-collapse: collapse; color: black;" AutoGenerateColumns="false"
                                            EmptyDataText="No Standard Images Found">
                                            <Columns>
                                ...
                                <div class="col-md-12">
                                    <div class="table-responsive">
                                        <asp:GridView ID="gvReplacementPhotos" runat="server" CssClass="table table-responsive TestTable"
                                            EmptyDataText="No Replacement Images Found" Style="border-collapse: collapse;
                                            color: black;" AutoGenerateColumns="false">
                                            <Columns>
                                                <asp:BoundField DataField="FileName" HeaderText="Image Name" />
                                                <asp:TemplateField HeaderText="Image" ItemStyle-HorizontalAlign="Center">
                                                    <ItemTemplate>
    ...
    <div id="myModalSupportiveDocuments" class="modal modal-primary fade" tabindex="-1"
            role="dialog" aria-hidden="true">
            <div class="modal-dialog">
                <!-- Modal content-->
                <div class="modal-content" style="background-color: #a2bdcc;">
                    <div class="modal-header" style="background-color: #7bd47dfa;">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">×</span></button>
                        <h4 class="modal-title">
                            Uploaded Supportive Documents</h4>
                    </div>
                    <div class="modal-body">
                        <div class="login-w3ls">
                            <div class="row">
    ...
    <div id="stockInfoModel" class="modal modal-primary fade" tabindex="-1" role="dialog"
            aria-hidden="true">
            <div class="modal-dialog">
                <!-- Modal content-->
                <div class="modal-content" style="background-color: #a2bdcc;">
                    ...
                    <div class="modal-body">
                        <div class="login-w3ls">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="table-responsive">
                                        <asp:GridView ID="gvStockInfo" runat="server" CssClass="table table-responsive TestTable"
                                            Style="border-collapse: collapse; color: black;" AutoGenerateColumns="false"
                                            EmptyDataText="No Stock Found">
                                            <Columns>
                                                <asp:BoundField DataField="ProId" HeaderText="ID" />
                                                <asp:BoundField DataField="StockBalance" HeaderText="Stock Balance" />
                                                <asp:BoundField DataField="LastPurchasePrice" HeaderText="Last Purchase Price" />
                                                <asp:BoundField DataField="SupplierID" HeaderText="Supplier ID" />
                                                <asp:BoundField DataField="LastPurchaseDate" HeaderText="Last Purchase Date" DataFormatString="{0:dd-M-yyyy}" />
                                                <asp:BoundField DataField="AvgConsumption" HeaderText="Avg Consumption" />
                                            </Columns>
                                        </asp:GridView>
                                    </div>
                                </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p style="font-weight: bold; font-size: medium;">
                            PR has been Approved Successfully</p>
                    </div>
                    <div class="modal-footer">
                        <asp:Button ID="btnOk" runat="server" OnClick="btnOK_Click" CssClass="btn btn-info"
                            Text="OK"></asp:Button>
                    </div>
                </div>
            </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 id="lblTitleConfirmYesNo1" class="modal-title">
                            Confirmation</h4>
                    </div>
                    <div class="modal-body">
                        <p>
                            Are you sure to Approve Purchase Requisition?</p>
                    </div>
                    <div class="modal-footer">
                        <asp:Button ID="btnYesConfirmYesNo" runat="server" CssClass="btn btn-primary" OnClick="btnApprove_Click"
                            Text="Yes"></asp:Button>
                        <button id="btnNoConfirmYesNo1" type="button" class="btn btn-danger">
                            No</button>
                    </div>
                </div>
            </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 id="lblTitleConfirmYesNo2" class="modal-title">
                            Confirmation</h4>
                    </div>
                    <div class="modal-body">
                        <p>
                            Are you sure to Reject Purchase Requisition?</p>
                    </div>
                    <div class="modal-footer">
                        <asp:Button ID="Button1" runat="server" CssClass="btn btn-primary" OnClick="btnReject_Click"
                            Text="Yes"></asp:Button>
                        <button id="btnNoConfirmYesNo2" type="button" class="btn btn-danger">
                            No</button>
                    </div>
                </div>
            </div>
   ...
   <!-- Main content -->
        ...
        <div class="col-sm-4 invoice-col">
          <address style="margin-bottom: 0px;">
            <strong>Request Information</strong><br />
               Requested By:&nbsp;&nbsp;&nbsp; <asp:Label ID="lblRequesterName" runat="server" Text=""></asp:Label><br />
               Requested For : &nbsp;&nbsp;&nbsp; <asp:Label ID="lblRequesterFor" runat="server" Text=""></asp:Label><br />
              PR Type : &nbsp;&nbsp;&nbsp; <asp:Label ID="lblPRType2" runat="server" Text=""></asp:Label><br />
          </address>
        </div>
        <!-- /.col -->
      </div>
    ...
    <div class="row">
        <div class="col-sm-4" style=" margin-left: 16px; ">
            ...
            <strong>Expense Information</strong> <br /> <asp:Label ID="lblFromBudget" runat="server" Text=""></asp:Label><br />
         <div id ="DvbudgetInfo" runat="server" visible="false">
            Budget Amount : &nbsp;&nbsp;&nbsp;<asp:Label ID="lblBudgetAmount" runat="server" Text=""></asp:Label><br />
            Budget Info : &nbsp;&nbsp;&nbsp;<asp:Label ID="lblBudgetInfo" runat="server" Text=""></asp:Label><br />
        ...
        <Columns>
            ...
            <asp:BoundField DataField="ItemId" HeaderText="Item Id" 
                HeaderStyle-CssClass="hidden" ItemStyle-CssClass="hidden">
                        ...
                        <asp:BoundField DataField="ProductDetailId" HeaderText="Product Detail Id" 
                HeaderStyle-CssClass="hidden" ItemStyle-CssClass="hidden">
            </asp:BoundField>
            ...
            <asp:BoundField DataField="ItemDescription" HeaderText="Item Description" />
              ...
              <ItemTemplate>
                      ...
                      <asp:Label ID="LabelProcedure" Text='<%#Eval("Proceduree").ToString()== "N"?"Normal":"Covering" %>' Font-Bold="true" ForeColor='<%#Eval("Proceduree").ToString()== "N"?System.Drawing.Color.Green:System.Drawing.Color.Red %>' runat="server"></asp:Label>
              </ItemTemplate>
            </asp:TemplateField>

              <asp:TemplateField HeaderText="Purchase Type">
              <ItemTemplate>
                  <asp:Label ID="Label2" runat="server" Text='<%# Eval("PurchaseType").ToString() =="L" ? "Local ":"Import  " %>'></asp:Label>
              </ItemTemplate>
            </asp:TemplateField>
            ...
            <asp:BoundField DataField="RequiredDate" HeaderText="Required Date" DataFormatString='<%$ appSettings:datePattern %>' />
           
           
             <asp:TemplateField HeaderText="Remarks"  HeaderStyle-CssClass="hidden" ItemStyle-CssClass="hidden">
              <ItemTemplate>
                  <asp:Label ID="Label3" runat="server" Text='<%# Eval("Remarks").ToString() =="" ? "-":"Remarks" %>'></asp:Label>
              </ItemTemplate>
            </asp:TemplateField>
              ...
              <asp:TemplateField HeaderText="Supportive Docs">
                   <ItemTemplate>
            ...
            <asp:TemplateField HeaderText="View Store Info">
              <ItemTemplate>
                  <asp:LinkButton runat="server" ID="lblStoreInfo" Text="View" 
                      onclick="lblStoreInfo_Click" ></asp:LinkButton>
              </ItemTemplate>
            </asp:TemplateField>
        </Columns>
    </asp:GridView>
