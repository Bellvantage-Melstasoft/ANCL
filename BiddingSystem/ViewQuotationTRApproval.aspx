<%@ Page Title="" Language="C#" MasterPageFile="~/BiddingAdmin.Master" AutoEventWireup="true" CodeBehind="ViewQuotationTRApproval.aspx.cs" Inherits="BiddingSystem.ViewQuotationTRApproval" %>
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField>
                                                                    <ItemTemplate>
                                                                        ...
                                                                        <tr style="color: White; background-color: #3C8DBC;">
                                                                            ...
                                                                            <td scope="col">Supplier Mentioned Name </td>
                                                                ...
                                                                <asp:TemplateField>
                                                                    <ItemTemplate>
                                                                        <tr>
                                                                            <td colspan="100%">
                                                                                <asp:Panel ID="pnlQuotationItems" runat="server" Style="margin-left: 40px; overflow-x: scroll;">
                                            ...
                                            <div class="col-xs-12">
                                                ...
                                                <div style="color: black; overflow-x: scroll;">
                                                    ...
                                                    <asp:GridView ID="gvQuotationItemsSup" runat="server"
                                                        CssClass="table table-responsive"
                                                        GridLines="None" AutoGenerateColumns="false"
                                                        Caption="Quotations" EmptyDataText="No Quotations Found" RowStyle-BackColor="#f5f2f2" HeaderStyle-BackColor="#525252" HeaderStyle-ForeColor="White" OnRowDataBound="gvQuotationItemsSup_RowDataBound">
                                                        <Columns>
                                                            <asp:TemplateField HeaderText="#" ItemStyle-Font-Bold="true">
                                                                <ItemTemplate>
                                                                    <span style="font: bold;">
                                                            ...
                                                            <asp:BoundField DataField="VatAmount" HeaderText="VAT" />
                                                            <asp:BoundField DataField="NetTotal" HeaderText="Net-Total" />--%>
                                                            <asp:BoundField DataField="SubTotal_Sup" HeaderText="Sub-Total" />
                                                            <asp:BoundField DataField="Nbt_sup" HeaderText="NBT" />
                                                            <asp:BoundField DataField="vat_sup" HeaderText="VAT" />
                                                            <asp:BoundField DataField="NetTotal_sup" HeaderText="Net-Total" />
                                                            <asp:BoundField DataField="SpecComply" HeaderText="Complies Specs" />
                                                            ...
                                                            <asp:TemplateField>
                                                                <ItemTemplate>
                                                                 <tr>
                                                                    <td colspan="100%">
                                                                 <asp:Panel ID="pnlSupplier" runat="server"  Style="margin-left: 40px; overflow-x: auto;">
                                                                      <asp:GridView ID="gvItemSupllier" runat="server"
                                                                                CssClass="table gvItems" Caption="Supplier"
                                                                                ...
                                                                                <Columns>
                                                                                    ...
                                                                                    <asp:TemplateField>
                                                                                        <ItemTemplate>
                                                                                            ...
                                                                                            <tr style="color: White; background-color: #3C8DBC;">
                                                                                                ...
                                                                                                <td scope="col">Last Purchased Price</td>
                                                                                                <td scope="col">Supplier Mentioned Name </td>
                                                                                                <td scope="col" style="padding-left:10px;">Purchase </td>
                                                                                                <td scope="col"></td>
                                                                                            </tr>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    ...
                                                                                    <asp:TemplateField HeaderText="Quantity">
                                                                                        <ItemTemplate>
                                                                                            <asp:Label runat="server" Text='<%# decimal.Parse(ProcessMyDataItem(Eval("Qty").ToString())).ToString() + " " + ProcessMyDataItem(Eval("UnitShortName").ToString()) %>' />
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    <asp:BoundField DataField="EstimatedPrice"
                                                                                        HeaderText="Estimated Price" />
                                                                ...
                                                                <asp:Panel ID="pnlBidItems" runat="server" Style="display: none">
                                                                    <asp:GridView ID="gvBidItems" runat="server"
                                                                        ...
                                                                        <Columns>
                                                                            ...
                                                                            <asp:TemplateField HeaderText="Quantity">
                                                                                <ItemTemplate>
                                                                                    <asp:Label runat="server" Text='<%# decimal.Parse(Eval("Qty").ToString()).ToString() + " " + ProcessMyDataItem(Eval("UnitShortName").ToString()) %>' />
                                                                                </ItemTemplate>
                                                                            </asp:TemplateField>
                                                                            <asp:BoundField DataField="EstimatedPrice"
                                                                                HeaderText="Estimated Price" />
                                                        ...
                                                        <asp:TemplateField HeaderText="Actions" HeaderStyle-Width="110px" ItemStyle-Width="110px">
                                                            <ItemTemplate>
                                                                ...
                                                                <asp:Button CssClass="btn btn-success btn-styled btn-xs margin" runat="server"
                                                                    ID="btnApprove" Text="Approve" Enabled='<%# Eval("btnEnablestatus").ToString() =="1" ? true:false %>'
                                                                    style="width:100px;" OnClientClick="TabulationApprove();"></asp:Button>

                                                                <asp:Button CssClass="btn btn-info btn-styled btn-xs btn-danger" runat="server" 
                                                                    ID="btnReject" Text="Reject" Enabled='<%# Eval("btnEnablestatus").ToString() =="2" ? true:false %>'
                                                                    style="width:100px;" OnClientClick="TabulationReject();"></asp:Button>
...
<%--                                                                    <button type="button" class="btn btn-success btn-styled btn-xs margin " onclick="TabulationApprove();" disabled >Approve</button>
                                                        ...
                                                        <asp:BoundField DataField="btnEnablestatus"
                                                                                HeaderText="aaa" />
                                                    </Columns>
                                                </asp:GridView>
                                            </div>
...
<%--                                    <asp:Button ID="btnApprove" runat="server" CssClass="btn btn-info btn-styled pull-right"  style="margin-right:10px" Text="Approve" OnClick="btnApprove_Click"/>--%>
                ...
                <asp:Button ID ="hdnbtnEnablestatus" runat="server" CssClass="hidden" OnClick="hdnbtnEnablestatus_click" />
