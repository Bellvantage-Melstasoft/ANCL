<%@ Page Title="" Language="C#" MasterPageFile="~/BiddingAdmin.Master" AutoEventWireup="true" CodeBehind="CompareQuotationsNew.aspx.cs" Inherits="BiddingSystem.CompareQuotationsNew" %>
                    ...
                    <div class="modal-dialog" style="width: 95%;">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-header" style="background-color: #3C8DBC; color: white">
                                <button type="button" class="close" onclick="RemoveBackdrop();" data-dismiss="modal" aria-label="Close" style="opacity: 1; color: white;">
                                    ...
                                    <div class="panel panel-default">
                                                        ...
                                                        <asp:GridView ID="gvItems" runat="server"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField HeaderText="Quantity">
                                                                    <ItemTemplate>
                                                                        <asp:Label runat="server" Text='<%# Eval("Qty").ToString()+ " " + Eval("UnitShortName").ToString() %>' />
                                                                                    ...
                                                                                    <asp:GridView ID="gvQuotationItems" runat="server"
                                                                                        ...
                                                                                        <Columns>
                                                                                            ...
                                                                                            <asp:TemplateField HeaderText="Requesting qty" HeaderStyle-Width="80px" ItemStyle-Width="80px">
                                                                                                <ItemTemplate>
                                                                                                    <asp:TextBox ID="txtRequestingQty" CssClass="txtRequestingQty" runat="server" Width="80px" onkeyup="Calculation(this)" Type="number" step="any" min="0.00"></asp:TextBox>
                                                                                                </ItemTemplate>
                                                                                            </asp:TemplateField>
                                                                                            <asp:TemplateField HeaderText="Requesting Unit" HeaderStyle-Width="80px" ItemStyle-Width="80px">
                                                                                                <ItemTemplate>
                                                                                                    <asp:Label runat="server" Text='<%#Eval("UnitShortName").ToString() %>' />
                                                                                                </ItemTemplate>
                                                                                            </asp:TemplateField>
                                                                                            ...
                                                                                            <asp:TemplateField HeaderText="Attachments" HeaderStyle-Width="130px" ItemStyle-Width="130px">
                                                                                                <ItemTemplate>
                                                                                                    <asp:Button CssClass="btn btn-info btn-styled btnViewAttachmentsClassA btn-xs" runat="server" ID="btnAttachMents" ValidationGroup="123"
                                                                                    ...
                                                                                    <ItemTemplate>
                                                                                       <asp:TextBox ID="txtSelectedQ" CssClass="txtSelectedQ" runat="server" Text="0"></asp:TextBox>
                                                                                        ...
                                                                                        <ItemTemplate>
                                                                                            ...
                                                                                            <asp:TemplateField HeaderText="Actions" HeaderStyle-Width="250px" ItemStyle-Width="250px" >
                                                                                                <ItemTemplate>
                                                                                                    <asp:Button ID="btnSelect" runat="server" Text="Select" class="btn btn-primary btn-styled  btn-xs pull-left btnSelect " OnClientClick="SelectBidClick(this ,'Items','Local');" Visible='<%# Eval("IsSelectedTB").ToString() == "1" ? false : true %>'/>
                                                                                                    <%--<button type="button" class="btn btn-primary btn-styled  btn-xs pull-left btnSelect " onclick="SelectBidClick(this ,'Items','Local');">
                                                                                                        Select
                                                                                                    </button>--%>
                                                                                                    <%-- <asp:Button ID="btnSelected" runat="server" enabled="false" Text="Selected" class="btn btn-success btn-styled  btn-xs pull-left  " Visible='<%# Eval("IsSelectedTB").ToString() == "1" ? true : false %>' />
                                                                                                   --%>
                                                                                                    <asp:Label ID="lblSelected" runat="server"  Text="SELECTED" Font-Bold="true" ForeColor="SeaGreen" Visible='<%# Eval("IsSelectedTB").ToString() == "1" ? true : false %>'></asp:Label><br>
                                                                                                         <%--<asp:ImageButton ID="btnDelete" CssClass="deleteItem pull-right hidden" ImageUrl="~/images/dlt.png" ToolTip="Delete" Style="width: 20px; height: 20px;" Visible='<%# Eval("IsSelectedTB").ToString() == "1" ? true : false %>'
                                                                                                runat="server"  OnClientClick="RemoveBidItemClick(this ,'Items','Local');"/>--%>
                                                                                                  <asp:Button ID="btnDelete" runat="server" Text="Delete" class="btn btn-danger btn-styled  btn-xs pull-left btnDelete " OnClientClick="RemoveBidItemClick(this ,'Items','Local');" Visible='<%# Eval("IsSelectedTB").ToString() == "1" ? true : false %>'/>
                                                                                             ...
                                                                                             <asp:TemplateField HeaderStyle-CssClass="hidden" ItemStyle-CssClass="hidden">
                                                                                                <ItemTemplate>
                                                                                                    <asp:Button ID="btnHidden" runat="server" Text="Hidden" class="btn btn-primary btn-styled  btn-xs pull-left btnDelete " OnClientClick="" Visible="true"/>
                                        ...
                                        <div class="box-footer">
                                            ...
                                            <asp:Button class="btn btn-info btn-styled" runat="server"  ID="btnPrintNew" Text="Print"  OnClick="btnPrint_Click"
                                             ...
                                             <button type="button" class="btn  btn-styled btn-success   pull-right " style="width:150px;" onclick="FinalizeTabulationClick('Local');" >Finalize Tabulation </button>
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="#" ItemStyle-Font-Bold="true">
                                                                                            ...
                                                                                            <asp:BoundField DataField="SupplierId" HeaderText="Supplier"
                                                                                                HeaderStyle-CssClass="hidden" ItemStyle-CssClass="hidden" />
                                                                                            <asp:BoundField DataField="SupplierName" HeaderText="Supplier" NullDisplayText="Unavailable" />
                                                                                          <%--<asp:BoundField DataField="QuotationCount" HeaderText="Quotations Count" NullDisplayText="Unavailable"    HeaderStyle-CssClass="hidden" ItemStyle-CssClass="hidden" />
                                                                                            ...
                                                                                            <asp:TemplateField HeaderText="Attachments" >
                                                                                                <ItemTemplate>
                                                                                                    <asp:Button CssClass="btn btn-info btn-styled btnViewAttachmentsClassA btn-xs " runat="server" ID="btnAttachMents" ValidationGroup="123"
                                                                                                        Text="View" OnClick="btnAttachMents_Click2"></asp:Button>
                                                                                                </ItemTemplate>
                                                                                            </asp:TemplateField>
                                                                      ...
                                                                      <asp:GridView ID="gvItemSupllier" runat="server"
                                                                                ...
                                                                                <Columns>
                                                                                    ...
                                                                                    <asp:TemplateField HeaderText="Requesting qty" HeaderStyle-Width="80px" ItemStyle-Width="80px">
                                                                                        ...
                                                                                        <asp:TextBox ID="txtRequestingQtySu" CssClass="txtRequestingQtySu"  onkeyup="CalculationSupplierNew(this);" runat="server" Width="80px" Type="number" step="any" min="0.00" Text='<%# Eval("RequestingQty") %>'></asp:TextBox>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    <asp:TemplateField HeaderText="Requesting Unit" HeaderStyle-Width="80px" ItemStyle-Width="80px">
                                                                                                <ItemTemplate>
                                                                                    ...
                                                                                    <asp:TemplateField HeaderText="VAT">
                                                                                        <ItemTemplate>
                                                                                            <asp:Label ID="lblVatSu" CssClass="lblVatSu" runat="server"  Text='<%# Eval("VAT", "{0:n2}").ToString()%>'></asp:Label>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    <asp:TemplateField HeaderText="Net-Total">
                                                                                        <ItemTemplate>
                                                                                            <asp:Label ID="lblNetTotalSu" CssClass="lblNetTotalSu" runat="server"  Text='<%# Eval("NetTotal", "{0:n2}").ToString()%>'></asp:Label>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    ...
                                                                                    <asp:TemplateField HeaderText=" Purchase ">
                                                                                        <ItemTemplate>
                                                                                            ...
                                                                                            <asp:Button CssClass="btn-xs btn-info btn-styled " runat="server"
                                                                                                ...
                                                                                                Style="margin-top: 3px; width: 100px;" OnClick="btnPurchased_Click2"></asp:Button>
                                                                                ...
                                                                                <asp:TemplateField HeaderText="Is Selected" HeaderStyle-CssClass="hidden" ItemStyle-CssClass="hidden">
                                                                                    ...
                                                                                    <%-- <%#(Eval("Data") == null ? "0" : Eval("Data"))%> --%>
                                                                                      ...
                                                                                      <asp:TemplateField HeaderText="Actions" HeaderStyle-Width="200px" ItemStyle-Width="200px">
                                                                                        <ItemTemplate>
                                                                                             <asp:Button ID="btnSelect" runat="server" Text="Select" class="btn btn-primary btn-styled  btn-xs pull-left btnSelect " OnClientClick="SelectBidClick(this ,'Supplier','Local');" Visible='<%# Eval("IsSelectedTB").ToString() == "1" ? false : true %>'/>
                                                                                                    
                                                                                            <%--<button type="button" class="btn  btn-styled btn-primary btn-xs btnSelectSu" onclick="SelectBidClick(this ,'Supplier','Local');">Select </button>--%>
                                                                                           <asp:Label ID="lblSelected" runat="server"  Text="SELECTED" Font-Bold="true" ForeColor="SeaGreen" Visible='<%# Eval("IsSelectedTB").ToString() == "1" ? true : false %>'></asp:Label> <br>
                                                                                            <%--<asp:ImageButton ID="btnDelete" CssClass="deleteItem pull-right hidden" ImageUrl="~/images/dlt.png" ToolTip="Delete" Style="width: 20px; height: 20px;"
                                                                                                runat="server"  OnClientClick="RemoveBidItemClick(this ,'Supplier','Local');"/>--%>
                                                                                             <asp:Button ID="Button1" runat="server" Text="Delete" class="btn btn-danger btn-styled  btn-xs pull-left btnDelete " OnClientClick="RemoveBidItemClick(this ,'Supplier','Local');" Visible='<%# Eval("IsSelectedTB").ToString() == "1" ? true : false %>'/>
                ...
                <div id="mdlItems" class="modal fade" tabindex="-1" role="dialog" style="z-index: 3000;"
                    ...
                    <div class="modal-dialog" style="width: 60%;">
                        ...
                        <div class="modal-content">
                            <!-- Start : Modal Header -->
                            <div class="modal-header" style="background-color: #3C8DBC; color: white">
                                <button type="button" class="close btnCloseLabelItem" data-dismiss="modal" onclick="RemoveBackdrop();" aria-label="Close" style="opacity: 1; color: white;">
                                    <span aria-hidden="true" style="opacity: 1;">×</span></button>
                           ...
                           <%-- <div class="container">
                            ...
                            <div class="box-footer">
                                ...
                                <button type="button" class="btn btn-info btn-styled   pull-right" onclick="ClosePR();">Close</button>
                    ...
                    <div class="modal-dialog">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="panel panel-default">
                                    <div class="panel-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <button type="button" class="close" data-dismiss="modal" onclick="RemoveBackdrop();" aria-label="Close" style="opacity: 1; background-color:red; color:white; padding:5px;">x</button>
                                                <h4 class="text-green text-bold" style="opacity: 1;">ATTACHMENT QUOTATIONS</h4>
                                            </div>
                                        </div>
                                        <hr />
                                        <div class="row">
                            ...
                            <div class="box-footer">
                                ...
                                <button type="button" class="btn btn-info btn-styled   pull-right" onclick="Close();">Close</button>
                            ...
                            <div class="box box-info">
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Actions" HeaderStyle-Width="110px" ItemStyle-Width="110px">
                                                            <ItemTemplate>
                                                                ...
                                                                <button type="button" class="btn btn-warning btn-styled pull-right TabluationBtn btn-xs"  style="margin-top:3px; width:100px;" onclick="ReOpenBidClickC(this);"> Re-Open-Bid </button>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                    </Columns>
                                                </asp:GridView>
                                ...
                                <div class="box-footer">
                                   ...
                                   <%-- <img id="loader" alt="" src="SupplierPortalAssets/assets/img/loader-info.gif" class="pull-right hidden" style="margin-right:10px; max-height:40px;" />
                                    ...
                                    <a class="btn btn-info btn-styled pull-right" href="ViewPrForQuotationComparison.aspx"
                                        style="margin-right:10px">Done</a>--%>
