<%@ Page Title="" Language="C#" MasterPageFile="~/BiddingAdmin.Master" AutoEventWireup="true" CodeBehind="ViewPrForTabulationsheetApprovals.aspx.cs" Inherits="BiddingSystem.ViewPrForTabulationsheetApprovals" %>
            ...
            <div class="table-responsive">
               <asp:GridView runat="server" ID="gvPurchaseRequest" GridLines="None" CssClass="table table-responsive tablegv" HeaderStyle-BackColor="#3C8DBC" HeaderStyle-ForeColor="White"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="ImportItemType"  HeaderText="ImportItemType" HeaderStyle-CssClass="hidden" ItemStyle-CssClass="hidden" />
                        <asp:TemplateField HeaderText="Action">
                            <ItemTemplate>
                                <%--<asp:LinkButton runat="server" ID="lbtnView"  CssClass="btn btn-info btn-styled " Text="View Bids" OnClick="lbtnView_Click"></asp:LinkButton>--%>
                                <asp:LinkButton runat="server" ID="lbtnViewNew"  CssClass="btn btn-info btn-styled " Text="View Bids" OnClick="lbtnViewNew_Click"></asp:LinkButton>
