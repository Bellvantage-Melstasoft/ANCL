<%@ Page Title="" Language="C#" MasterPageFile="~/BiddingAdmin.Master" AutoEventWireup="true" CodeBehind="ViewMRNRequestsExpenseApprove.aspx.cs" Inherits="BiddingSystem.ViewMRNRequestsExpenseApprove" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentSection" runat="server">
    ...
    <section class="content-header">
        <h1>
         View - Add Availability / Approve Expense MRN
            <small></small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="AdminDashboard.aspx"><i class="fa fa-home"></i> Home</a></li>
            <li class="active">Add Availability / Approve Expense MRN  </li>
        </ol>
    </section>
    <br />
                                            ...
                                            <asp:TemplateField  HeaderText="Current Status" >
                                                <ItemTemplate>
                                                    <asp:Label runat="server"
                                                        ...
                                                        Text="MRN APPROVED/NEXT STEP PENDING" CssClass="label label-warning" />   <!-- Since from query approved mrn is fetched -->
                                                    <asp:Label runat="server"
