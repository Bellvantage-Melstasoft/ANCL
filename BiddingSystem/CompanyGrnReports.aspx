					...
					<div class="modal-content" ">
					  ...
					  <div class="modal-body">
						<div class="login-w3ls">
                            <div style="position: relative;background: #fff;overflow:hidden; border: 1px solid #f4f4f4;padding: 20px;margin: 10px 25px;" id="divPrintPoReport" >    <!-- Main content -->
        ...
        <div class="box-header with-border">
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="col-sm-4">
                         <label>Status</label> <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" InitialValue="" ControlToValidate="ddlStatus"   ValidationGroup="btnGrnStatusSearch" ForeColor="Red">*</asp:RequiredFieldValidator>
