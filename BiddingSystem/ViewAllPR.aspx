<%@ Page Title="" Language="C#" MasterPageFile="~/BiddingAdmin.Master" AutoEventWireup="true" CodeBehind="ViewAllPR.aspx.cs" Inherits="BiddingSystem.ViewAllPR" %>
        ...
        <asp:UpdatePanel ID="Updatepanel1" runat="server">
            <ContentTemplate>
                                ...
                                <div class="col-xs-12">
                                    ...
                                    <div style="color: black;">
                                        <asp:GridView ID="gvPrDetails" runat="server" OnRowDataBound="gvPrDetails_RowDataBound"
                                            CssClass="table table-responsive" GridLines="None" AutoGenerateColumns="false" EmptyDataText="No PRs Found" RowStyle-BackColor="#f5f2f2" HeaderStyle-BackColor="#525252" HeaderStyle-ForeColor="White">
                                            <Columns>
                ...
                <section class="content-header">
                    <h1>View All Purchase Request Notes<small></small></h1>
                    <ol class="breadcrumb">
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <asp:ListBox ID="ddlDepartment" SelectionMode="Multiple" runat="server" CssClass="select2 form-control" Style="color: black; width: 100%"></asp:ListBox>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <label class="lblerror hidden" style="color: red;">*Fill this field</label>
                                        <div class="form-group">
                    ...
                    <div class="panel panel-default" id="panelGridview" runat="server">
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <asp:GridView runat="server" ID="gvPr" GridLines="None" HeaderStyle-BackColor="#3C8DBC" HeaderStyle-ForeColor="White" CssClass="table table-responsive fixed tablegv" AutoGenerateColumns="false" DataKeyNames="PrID" EmptyDataText="No records Found"
                                    ...
                                    <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="PR Code">
                                            <ItemTemplate>
                                                <a href='<%# "PRInquiryReport_2.aspx?PRCode=" + Eval("PrCode").ToString() %>'><%# "PR-"+ Eval("PrCode").ToString() %></a>
                                            </ItemTemplate>
                                        </asp:TemplateField>
