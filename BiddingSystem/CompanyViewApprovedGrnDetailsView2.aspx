<%@ Page Title="" Language="C#" MasterPageFile="~/BiddingAdmin.Master" AutoEventWireup="true" CodeBehind="CompanyViewApprovedGrnDetailsView2.aspx.cs" Inherits="BiddingSystem.CompanyViewApprovedGrnDetailsView2" %>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-sm-4 text-center"><b>Received QTY </b><p id="receivedQtyShow"></p></div>
                                <div class="col-sm-4 text-center"><b>Issued QTY </b><p id="issuedQtyShow"></p></div>
                                <div class="col-sm-4 text-center"><b>Pending QTY </b><p id="pendingQtyShow"></p></div>
                            </div>
                            <div class="row">
                                <div class="co-md-12">
                                        ...
                                        <asp:GridView ID="gvWarehouseInventory" runat="server" CssClass="table table-responsive tablegv" GridLines="None" AutoGenerateColumns="false" EmptyDataText="No Records Found" AllowPaging="true" PageSize="20">
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Quantity">
                                                    <ItemTemplate>
                                                        <asp:TextBox runat="server" ID="IssuedQty" type="number" AutoPostBack="true" OnTextChanged="IssuedQty_TextChanged" min="0"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            </Columns>
                                        </asp:GridView>
                        ...
                        <div class="modal-footer">
                            <asp:Button ID="btnIssue" runat="server" Text="Issue" CssClass="btn btn-primary pull-right" OnClick="btnIssue_Click" Style="margin-right: 10px"  />
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="table-responsive">
        ...
        <Columns>
           <%--  <asp:TemplateField>
            ...
            <asp:BoundField DataField="GrndID" HeaderText="GRND ID" HeaderStyle-CssClass="hidden" ItemStyle-CssClass="hidden"/>
            ...
            <asp:TemplateField HeaderText="Action">
                <ItemTemplate>
                    <asp:Button runat="server" ID="btnIssueToWarehouse" CssClass="btn btn-sm btn-info" style="margin:5px" Width="140px" Text="Issue to Warehouse" OnClick="btnIssueToWarehouse_Click" Visible='<%# decimal.Parse(Eval("IssuedQty").ToString()) < decimal.Parse(Eval("Quantity").ToString())?true: false %>'></asp:Button>
                </ItemTemplate>
            </asp:TemplateField> 
        </Columns>
    </asp:GridView>
