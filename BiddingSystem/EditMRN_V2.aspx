<%@ Page Title="" Language="C#" MasterPageFile="~/BiddingAdmin.Master" AutoEventWireup="true" CodeBehind="EditMRN_V2.aspx.cs" Inherits="BiddingSystem.EditMRN_V2" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentSection" runat="server">
   ...
   <script src="AppResources/js/jquery-ui.js" type="text/javascript"></script>
            ...
            <div class="panel wizard">
                <div class="panel-body">
                    <div class="row">
                        <div class="col-xs-12">
                            <h4>
                                <b>EDIT</b> MATERIAL REQUEST NOTE <br>
                                <hr>
                            </h4>
                        </div>
                    </div>
    ...
    <script>
        var mrnMaster = <%= GetMrn() %>;
        console.log(mrnMaster);
    </script>
    <script src="Scripts/EditMrn.js?v=<%DateTime.Now.ToString();%>"></script>
</asp:Content>
