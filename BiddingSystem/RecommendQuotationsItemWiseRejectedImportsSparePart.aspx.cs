...
{
    public partial class RecommendQuotationsItemWiseRejectedImportsSparePart : System.Web.UI.Page
    {
        #region properties
       // static int PrId = 0;
      //  static int BidId = 0;
      ...
      //  static PrMasterV2 PrMaster;
       ...
       // static TabulationMaster tabulationMaster;
        ...
        protected void btnPrint1_Click(object sender, EventArgs e) {
            ...
            gv.Columns.Add(new BoundField() { DataField = "ImpMillCurrencyName", HeaderText = "Currency" });
