<%@ Page Title="" Language="C#" MasterPageFile="~/BiddingAdmin.Master" AutoEventWireup="true" CodeBehind="RejectedReceivedInventory.aspx.cs" Inherits="BiddingSystem.RejectedReceivedInventory" %>
                  ...
                  ID="gvDeliveredInventory" GridLines="None" CssClass="table table-responsive tablegv" AutoGenerateColumns="false" DataKeyNames="MrndInID" EmptyDataText="No records Found">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Action">
                            <ItemTemplate>
                                <asp:LinkButton runat="server" ID="btnReturn" Text="Return Stock to Warehouse" OnClick="btnReturnStock_Click"></asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
