<%@ Page Title="" Language="C#" MasterPageFile="~/BiddingAdmin.Master" AutoEventWireup="true" CodeBehind="ViewPrForQuotationApprovalNew.aspx.cs" Inherits="BiddingSystem.ViewPrForQuotationApprovalNew" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentSection" runat="server">
      <script src="AdminResources/js/jquery.min.js" type="text/javascript"></script>
 <section class="content-header">
      <h1>
     Sub/Procurement Committee Approval 
        <small></small>
      </h1>
      <ol class="breadcrumb">
