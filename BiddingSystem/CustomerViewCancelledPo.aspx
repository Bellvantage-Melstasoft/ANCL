<%@ Page Title="" Language="C#" MasterPageFile="~/BiddingAdmin.Master" AutoEventWireup="true" CodeBehind="CustomerViewCancelledPo.aspx.cs" Inherits="BiddingSystem.CustomerViewCancelledPo" %>
        ...
        <asp:UpdatePanel ID="Updatepanel1" runat="server">
            <ContentTemplate>
                <section class="content-header">
                    <h1>View Cancelled Purchase Orders
        <small></small>
                    </h1>
                    <ol class="breadcrumb">
                        <li><a href="AdminDashboard.aspx"><i class="fa fa-dashboard"></i>Home</a></li>
                        <li class="active">View Cancelled Purchase Orders </li>
                    </ol>
                </section>
                <br />
                        ...
                        <div class="box-header with-border">
                           ...
                           <%-- <asp:TextBox ID="txtFDt" runat="server" CssClass="txtFDt"></asp:TextBox>--%>
                            ...
                            <div class="row">
                                ...
                                <%--<asp:ListItem  Value="2">Modified PO</asp:ListItem> --%>
                                <%-- <asp:ListItem  Value="3">Covering PO</asp:ListItem>   
                                    </asp:DropDownList>  
                         </div>--%>
                            </div>
                            <div class="row">
                                    ...
                                    <div class="table-responsive">
                                        <asp:GridView runat="server" ID="gvPurchaseOrder" EmptyDataText="No Records Found" GridLines="None" CssClass="table table-responsive"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="Description" HeaderText="Quotation For" />
