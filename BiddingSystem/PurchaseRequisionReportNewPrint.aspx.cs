...
namespace BiddingSystem {
    public partial class PurchaseRequisionReportNewPrint : System.Web.UI.Page {
        ...
        protected void Page_Load(object sender, EventArgs e) {
            ...
            if (!IsPostBack) {
                ...
                List<Bidding> BidList = biddingController.FetchBidInfoForPRRequisitionReport(PRIds);
