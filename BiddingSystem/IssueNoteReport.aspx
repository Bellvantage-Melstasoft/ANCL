                ...
                <ContentTemplate>
                    <div class="panel panel-default no-print">
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator1" ForeColor="Red" Font-Bold="true" ControlToValidate="ddlDepartments" ValidationGroup="btnSearch">*</asp:RequiredFieldValidator>
                                        <asp:ListBox ID="ddlDepartments" SelectionMode="Multiple" runat="server" CssClass="select2 form-control" Style="color: black; width: 100%"></asp:ListBox>
                                    </div>
                                </div>
                            ...
                            <div class="col">
                                <div class="form-group">
                                    <asp:Button runat="server" ID="btnSearch" ValidationGroup="btnSearch" CssClass="btn btn-primary" Text="Search" OnClick="btnSearch_Click" />
                                    ...
                                    <button runat="server" id="btnRun" onserverclick="btnRun_ServerClick" class="btn btn-success ml" title="Export To Excel">
