<%@ Page Title="" Language="C#" MasterPageFile="~/BiddingAdmin.Master" AutoEventWireup="true" CodeBehind="CreatePR_V2.aspx.cs" Inherits="BiddingSystem.CreatePR_V2" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentSection" runat="server">
            ...
            <div class="panel wizard">
                <div class="panel-body">
                    <div class="row">
                        <div class="col-xs-12">
                            <h4>
                                <b>CREATE</b> PURCHASE REQUEST NOTE <br>
                                <hr>
                            </h4>
                        </div>
                    </div>
    ...
    <script src="Scripts/CreatePR.js?v=<%DateTime.Now.ToString();%>"></script>
</asp:Content>
