<%@ Page Title="" Language="C#" MasterPageFile="~/BiddingSupplier.Master" AutoEventWireup="true" EnableEventValidation="false"
    CodeBehind="BidDetails.aspx.cs" Inherits="BiddingSystem.BidDetails" %>
...
<script src="AppResources/themes/js/jquery.js" type="text/javascript"></script>
    ...
    <!-- Start - Popup to load Uploaded Images While Pr Create /Display company user added files  -->
    ...
    <!-- End - Popup to load Uploaded Images While Pr Create /Display company user added files  -->
      ...
      <ul class="breadcrumb">
        ...
        <div class="span6">
            ...
            <div class="control-group">
                <br />
                <div class="controls">
                        <h5 class="span2" style="margin-left: 0px;">Item Specifications</h5>
            ...
            <div class="span6" style="margin-left: 0px;">
                    <h5 style="margin-left: 0px;">Bid terms and conditions : &nbsp;&nbsp;
                    <asp:Label ID="lblTermsConditions" runat="server" Text=""></asp:Label></h5>
                </div>
            <br />

            <div class="span6">
                    <button id="btnPaticipate" type="button" class="btn btn-primary" style="padding: 11px;padding-left: 40px;padding-right: 40px;" onclick="return btnPaticipate_onclick()">Participate</></button>
                </div>
            ...
            <div id="divButtons" class="span6" style="display: none;">
                <asp:Button ID="btnApplyNow" class="btn btn-primary" runat="server" Text="Apply Now" style="padding: 11px;padding-left: 40px;padding-right: 40px;margin-left:10px" onclick="btnApplyNow_Click"/>
...
<script type="text/javascript">
    ...
    // If the count down is finished, write some text (You can Fire a Event (eg: Page reload))
    if (distance < 0) {
        clearInterval(x);
