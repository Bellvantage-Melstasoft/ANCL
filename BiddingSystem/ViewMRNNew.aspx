<%@ Page Language="C#" MasterPageFile="~/BiddingAdmin.Master" AutoEventWireup="true" CodeBehind="ViewMRNNew.aspx.cs" Inherits="BiddingSystem.ViewMRNNew" %>
                        ...
                        <asp:GridView ID="gvIssueNote" runat="server" CssClass="table table-responsive" GridLines="None" AutoGenerateColumns="false"
                          EmptyDataText="No Issue Notes Found" RowStyle-BackColor="#f5f2f2" HeaderStyle-BackColor="#525252" HeaderStyle-ForeColor="White">
                             <Columns>                                                                   
                                 ...
                                 <asp:BoundField DataField="IssuedUser"  HeaderText="Issued By" NullDisplayText="Not Found"/>
                                       
                                 <%--<asp:BoundField DataField="" HeaderText="Issued On"/>--%>
                                 <asp:TemplateField HeaderText="Issued On">
                                    <ItemTemplate>
                                        <%# (DateTime)Eval("IssuedOn") == DateTime.MinValue ? "Not Found" : string.Format("{0:MM-dd-yyyy}", (DateTime)Eval("IssuedOn")) %>
                                    </ItemTemplate>
                                    </asp:TemplateField>
                                 ...
                                 <asp:TemplateField HeaderText="Delivered On">
                                    <ItemTemplate>
                                        <%# (DateTime)Eval("DeliveredOn") == DateTime.MinValue ? "Not Found" : string.Format("{0:MM-dd-yyyy}", (DateTime)Eval("DeliveredOn")) %>
                                    </ItemTemplate>
                                    </asp:TemplateField>
        ...
        <div class="modal-dialog">
            ...
            <div class="box box-info">
                    ...
                    <div class="box-footer no-print">
                        ...
                        <asp:Button runat="server" ID="btnModify" CssClass="btn btn-warning" Text="Edit MRN" OnClick="btnModify_Click" />
