<%@ Page Title="" Language="C#" MasterPageFile="~/BiddingAdmin.Master" AutoEventWireup="true" CodeBehind="CompareQuotationsNewImportsNewSparePart.aspx.cs" Inherits="BiddingSystem.CompareQuotationsNewImportsNewSparePart" %>
...
<%--                                                                                            <asp:BoundField DataField="CurrencyType" HeaderText="Currency Type" NullDisplayText="Unavailable" />--%>
                                                                                            ...
                                                                                            <asp:BoundField DataField="Mill" HeaderText="Mill" NullDisplayText="Unavailable" HeaderStyle-CssClass="hidden" ItemStyle-CssClass="hidden"/>
                                                                                            <asp:BoundField DataField="Remark" HeaderText="Remark" NullDisplayText="Unavailable" />
                                                                                            <asp:BoundField DataField="History" HeaderText="History" NullDisplayText="Unavailable" HeaderStyle-CssClass="hidden" ItemStyle-CssClass="hidden"/>
                                                                                            <asp:BoundField DataField="Vlidity" HeaderText="Vlidity" DataFormatString="{0: dd-MMM-yyyy}" HeaderStyle-CssClass="hidden" ItemStyle-CssClass="hidden"/>
                                                                                            <asp:BoundField DataField="EstDelivery" HeaderText="Est Delivery" NullDisplayText="Unavailable" />
                                                                                            <%--<asp:BoundField DataField="ClearingCost" HeaderText="Clearing Cost" NullDisplayText="Unavailable" />
                                                                                            <asp:BoundField DataField="OtherCost" HeaderText="Other Cost" NullDisplayText="Unavailable" />--%>
                                                                                ...
                                                                                <asp:GridView ID="gvItemSupllier" runat="server"
                                                                                    ...
                                                                                    <Columns>
                                                                                        ...
                                                                                        <asp:BoundField DataField="ImpBrand"
                                                                                            HeaderText="Brand" />
                                                                                        <asp:BoundField DataField="Mill" HeaderStyle-CssClass="hidden" ItemStyle-CssClass="hidden"
                                                                                            HeaderText="Mill" />
                                                                                        <asp:BoundField DataField="ImpHistory" HeaderStyle-CssClass="hidden" ItemStyle-CssClass="hidden"
                                                                                            HeaderText="History" />
                                                                                        <asp:BoundField DataField="ImpRemark"
                                                                                            HeaderText="Remark" />
                                                                                        <asp:BoundField DataField="ImpValidity" HeaderStyle-CssClass="hidden" ItemStyle-CssClass="hidden"
                                                                                            HeaderText="Validity" />
                                        ...
                                        <div style="color: black;">
                                            ...
                                            <asp:GridView ID="GridImportDetails" runat="server" ShowHeaderWhenEmpty="True" EmptyDataText="No Import records."
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="Mill" HeaderText="Mill" HeaderStyle-CssClass="hidden" ItemStyle-CssClass="hidden" />
                                                    ...
                                                    <asp:BoundField DataField="Validity" HeaderText="Validity" HeaderStyle-CssClass="hidden" ItemStyle-CssClass="hidden"/>
                                                    <asp:BoundField DataField="EstDelivery" HeaderText="Estimated Deivery" />
                                                    <asp:BoundField DataField="ImportHistory" HeaderText="Import History" HeaderStyle-CssClass="hidden" ItemStyle-CssClass="hidden"/>
    ...
    <script>
        ...
        function SelectBidClick(elmt, status, pageStatus) {
            ...
            if (status == "Items") {
                ...
                $('#ContentSection_hdnDayNo').val($(elmt).closest('tr').find('td').eq(28).text());
            } else {
                ...
                $('#ContentSection_hdnUitPriceForeign').val($(elmt).closest('tr').find('td').eq(23).text());
                $('#ContentSection_hdnUnitPriceLKR').val($(elmt).closest('tr').find('td').eq(24).text());
                $('#ContentSection_hdnPurchaseType').val($(elmt).closest('tr').find('.lblPaymentModeIdSu').text());
                $('#ContentSection_hdnDayNo').val($(elmt).closest('tr').find('td').eq(33).text());
            }
