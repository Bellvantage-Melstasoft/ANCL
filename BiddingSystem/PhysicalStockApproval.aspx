<%@ Page Title="" Language="C#" MasterPageFile="~/BiddingAdmin.Master" AutoEventWireup="true" CodeBehind="PhysicalStockApproval.aspx.cs" Inherits="BiddingSystem.PhysicalStockApproval" %>
          ...
          <div class="row">
            ...
            <div class="table-responsive">
               ...
               <hr/>
                ...
                <%--<asp:Button Id="btnExport"  CssClass="btn btn-success "  runat="server" Text="Export" Visible="false" />--%>
                <asp:Button CssClass="btn btn-warning btnApproveSelectionCl" ID="btnApprove" runat="server" Text="Approve"  Visible="false"/>
                <asp:Button CssClass="btn btn-danger btnRejectSelectionCl" ID="btnReject" runat="server" Text="Reject" Visible="false"/>
               
                </span>
               </div>
            </div>
            <asp:HiddenField ID="hdnRemarks" runat="server" />
            <asp:Button ID="btnApproveSelection" runat="server" CssClass="hidden" OnClick="btnApprove_Click"/>
            <asp:Button ID="btnRejectSelection" runat="server" CssClass="hidden" OnClick="btnReject_Click"/>
            </ContentTemplate>
    </asp:UpdatePanel>
         </form>
    </section>
            ...
            $(function () {
                ...
                $('.btnApproveSelectionCl').on({
                    click: function () {
                        ...
                        swal.fire({
                            title: 'Are you sure?',
                            html: "Are you sure you want to Approve the physical stock?</br></br>"
                            ...
                            if (result.value) {
                                ...
                                $('#ContentSection_btnApproveSelection').click();
                            }
                        });
                ...
                $('.btnRejectSelectionCl').on({
                    click: function () {
                        ...
                        swal.fire({
                            title: 'Are you sure?',
                            html: "Are you sure you want to Reject the physical stock?</br></br>"
                                + "<strong id='dd'>Remarks</strong>"
                                + "<input id='ss' type='text' class ='form-control' required='required'/></br>",
                            type: 'warning',
                            cancelButtonColor: '#d33',
                            ...
                            if (result.value) {
                                $('#ContentSection_btnRejectSelection').click();
                            }
                        });
