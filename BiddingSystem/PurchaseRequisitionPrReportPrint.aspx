<%@ Page Title="" Language="C#" MasterPageFile="~/BiddingAdmin.Master" AutoEventWireup="true" CodeBehind="PurchaseRequisitionPrReportPrint.aspx.cs" Inherits="BiddingSystem.PurchaseRequisitionPrReportPrint" %>
                ...
                <section class="content" >
                    <div class="box box-info" id="panelPurchaseRequset" runat="server" >
                        <div class="box-header with-border">
                            <h3 class="box-title" style="text-align:center">Purchase Requisition Report</h3>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="table-responsive">
                                        <asp:GridView runat="server" ID="gvMrn"
                                            ...
                                            <asp:BoundField DataField="ExpectedDate" HeaderText="Expected Date" DataFormatString="{0:dd MMM yyyy}"/>
                                            ...
                                            <asp:BoundField DataField="CreatedDate" HeaderText="Created Date" DataFormatString="{0:dd MMM yyyy}"/>
                                                ...
                                                <asp:TemplateField>
                                                     <ItemTemplate>
                                                        ...
                                                        <asp:Panel ID="pnlMrnDetails" runat="server"  Style="margin-left: 40px; overflow-x:auto;">
                                                        <asp:GridView ID="gvMrnDetails" runat="server"
                                                                CssClass="table table-responsive ChildGridTwo"
                                                                GridLines="None" AutoGenerateColumns="false" 
                                                                 Caption="Items in Material Request"
                                    ...
                                    <div class="table-responsive">
                                        <asp:GridView runat="server" ID="gvPurchaseRequest"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="ExpectedDate" HeaderText="Date Of Request" DataFormatString="{0:dd MMM yyyy}" HeaderStyle-CssClass="hidden"
                                                                        ItemStyle-CssClass="hidden" />
                                               ...
                                               <%-- <asp:TemplateField HeaderText="Current Status">
                                                 ...
                                                 <asp:TemplateField>
                                                     <ItemTemplate>
                                                        ...
                                                        <asp:Panel ID="pnlPrDetails" runat="server" Style="margin-left: 40px; overflow-x:auto;">
                                                        <asp:GridView ID="gvPrDetails" runat="server"
                                                                CssClass="table table-responsive ChildGridTwo"
                                                                GridLines="None" AutoGenerateColumns="false" 
                                                                DataKeyNames="PrdId" Caption="Items in Purchase Request"
...
--%>
                                                               ...
                                                               <%-- <asp:TemplateField HeaderText="Bid Status">
                                                                ...
                                                                <asp:BoundField DataField="ApprovalRemarks"
                                                                    HeaderText="Remarks" NullDisplayText="-" HeaderStyle-CssClass="hidden" ItemStyle-CssClass="hidden" />
                                                                <asp:BoundField DataField="QuotationSelectedByName"
                                                                    HeaderText="Selection Finalized By" NullDisplayText="-" HeaderStyle-CssClass="hidden" ItemStyle-CssClass="hidden" />

                                                                <asp:TemplateField HeaderText="Selection Finalized on" HeaderStyle-CssClass="hidden" ItemStyle-CssClass="hidden" >
                                                                                    <ItemTemplate>
                                                                                       <%# (DateTime)Eval("QuotationSelectionDate") == DateTime.MinValue ? "-" : Eval("QuotationSelectionDate", "{0:dd MMM yyyy}") %>
                                                                                    </ItemTemplate>
                                                                                     </asp:TemplateField>
                                                     ...
                                                     <ItemTemplate>
                                                         <tr>
                                                           <td colspan="100%">
                                                                          ...
                                                                          <asp:Panel ID="pnlBidItems" runat="server" Style="margin-left: 40px; overflow-x:auto;">
                                                                                                        ...
                                                                                                        <asp:Panel ID="pnlQuotationItems" runat="server" Style="margin-left: 40px; overflow-x:auto;">
                                                                                                            <asp:GridView ID="gvQuotationItems" runat="server"
                                                                                                                ...
                                                                                                                <Columns>
                                                                                                                    ...
                                                                                                                    <asp:BoundField DataField="SpecComply" HeaderText="Complies Specs" HeaderStyle-CssClass="hidden" ItemStyle-CssClass="hidden"/>
                                                                                                                    <asp:BoundField DataField="SelectedByName" HeaderText="Selected By" NullDisplayText="-"/>
                                                                                                                     <asp:BoundField DataField="SelectedDate" HeaderText="Selected On" DataFormatString="{0:dd MMM yyyy}"/>
                            ...
                            <h4><b>Tabulation Recommendation</b></h4>
                                                    <div class="table-responsive">
                                                        <asp:GridView runat="server" ID="gvRecMaster"
                                                            ...
                                                            <Columns>
                                                                        ...
                                                                        <asp:Panel ID="pnlTabRecDetails" runat="server"
                                                                            ...
                                                                            <asp:GridView ID="gvTabRecDetails" runat="server"
                                                                                ...
                                                                                <Columns>
                                                                                    ...
                                                                                    <ItemTemplate>
                                                                                       <%# (DateTime)Eval("RecommendedDate") == DateTime.MinValue ? "-" : Eval("RecommendedDate", "{0:dd MMM yyyy}") %>
                                                                                    </ItemTemplate>
                                                                                     </asp:TemplateField>
                                                                ...
                                                                <asp:TemplateField HeaderText="Recommendation Overridden On" >
                                                                    <ItemTemplate>
                                                                       <%# (DateTime)Eval("RecommendationOveriddenOn") == DateTime.MinValue ? "-" : Eval("RecommendationOveriddenOn", "{0:dd MMM yyyy}") %>
                                                                    </ItemTemplate>
                                                                     </asp:TemplateField>
                                                     ...
                                                     <ItemTemplate>
                                                         <tr>
                                                           <td colspan="100%">
                                                                        ...
                                                                        <asp:Panel ID="pnlTabRecDetails" runat="server" Style="margin-left: 40px; overflow-x:auto;">
                                                                            <asp:GridView ID="gvTabRecDetails" runat="server"
                                                                                CssClass="table table-responsive ChildGridTwo"
                                                                                GridLines="None"
                                                                                AutoGenerateColumns="false"
                                                        ...
                                                        <asp:GridView runat="server" ID="gvAppMaster"
                                                            ...
                                                            <Columns>
                                                                        ...
                                                                        <asp:Panel ID="pnlTabAppDetails" runat="server"
                                                                            ...
                                                                            <asp:GridView ID="gvTabAppDetails" runat="server"
                                                                                ...
                                                                                <Columns>
                                                                                    ...
                                                                                    <ItemTemplate>
                                                                                       <%# (DateTime)Eval("ApprovedDate") == DateTime.MinValue ? "-" : Eval("ApprovedDate", "{0:dd MMM yyyy}") %>
                                                                                    </ItemTemplate>
                                                                                     </asp:TemplateField>
                                                                                    <asp:BoundField DataField="Remarks" HeaderText="Remarks" NullDisplayText="-" />
                                                                ...
                                                                <asp:TemplateField HeaderText="Approval Overridden On" >
                                                                    <ItemTemplate>
                                                                       <%# (DateTime)Eval("ApprovalOverriddenOn") == DateTime.MinValue ? "-" : Eval("ApprovalOverriddenOn", "{0:dd MMM yyyy}") %>
                                                                    </ItemTemplate>
                                                                     </asp:TemplateField>
                                                     ...
                                                     <ItemTemplate>
                                                         <tr>
                                                           <td colspan="100%">
                                                               ...
                                                               <asp:Panel ID="pnlTabAppDetails" runat="server" Style="margin-left: 40px; overflow-x:auto;">
                                                                            <asp:GridView ID="gvTabAppDetails" runat="server"
                                                                                CssClass="table table-responsive ChildGridTwo"
                                                                                GridLines="None"
                                                                                AutoGenerateColumns="false"
                                                     ...
                                                     <ItemTemplate>
                                                         <tr>
                                                           <td colspan="100%">
                                                               ...
                                                               <asp:Panel ID="pnlPoitems" runat="server" Style="margin-left: 40px; overflow-x:auto;">
                                                                            <asp:GridView ID="gvPoItems" runat="server"
                                                                                CssClass="table table-responsive ChildGridTwo"
                                                                                GridLines="None"
                                                                                AutoGenerateColumns="false"
