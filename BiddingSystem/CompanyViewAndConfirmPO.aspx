<%@ Page Title="" Language="C#" MasterPageFile="~/BiddingAdmin.Master" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="CompanyViewAndConfirmPO.aspx.cs" Inherits="BiddingSystem.CompanyViewAndConfirmPO" %>
 ...
 <section class="content-header">
    <h1>
      ...
      <ol class="breadcrumb">
        ...
        <li><a href=" CustomerApprovePO.aspx">PO Pending Approval</a></li>
   ...
   <div class="content" style="position: relative;background: #fff;overflow:hidden; border: 1px solid #f4f4f4;" id="divPrintPo" runat="server" >    <!-- Main content -->
    ...
    <div class="table-responsive">
      ...
      <div class="row no-print">
          ...
          <div  class="col-md-4">
                   <label id="lblPaymentMethod">Payment Method</label>
        ...
        <div class="col-xs-12">
          ...
          <asp:Button ID="btnReject" runat="server" Text="Reject"  class="btn btn-danger pull-right" ></asp:Button>
        </div>
...
function validataAlFields(status) {
    ...
    if (count > 0) {
        if (status == 1) {
            ...
            {
                $('#lblPaymentMethod').css('color', 'Red');
                return false;
            }
