<%@ Page Title="" Language="C#" MasterPageFile="~/BiddingAdmin.Master" AutoEventWireup="true" CodeBehind="EditTR.aspx.cs" Inherits="BiddingSystem.EditTR" %>
    ...
    <form id="form1" runat="server" enctype="multipart/form-data">
        ...
        <div class="box-body">
          <div class="row">
             <div class="col-md-6">
                ...
                <div class="form-group">
                    <label for="exampleInputEmail1">TR Code</label>
                     <asp:TextBox ID="txtTrCode" runat="server"  CssClass="form-control" Enabled="false" ></asp:TextBox>
                </div>
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                   ...
                   <asp:TextBox ID="txtTrDescription" runat="server" TextMode="MultiLine"  CssClass="form-control"></asp:TextBox>
                </div>
              <!-- /.form-group -->
            </div>
              <div class="col-md-6">
                  ...
                  <div class="form-group">
                    <label for="exampleInputEmail1">Warehouse Heads</label>
                    <asp:TextBox ID="txtWarehouseHeads" runat="server" CssClass="form-control"></asp:TextBox>
                       
                </div>
                  
                  <div class="form-group">
                    <label for="exampleInputEmail1">Requesting Warehouse</label>
     ...
     <div class="box box-danger" id="AddItemsDiv">
      ...
      <div class="box box-primary">
        ...
        <div class="form-group">
              <label for="exampleInputEmail1" style="visibility:hidden">Category Name</label>
              <asp:Button ID="btnSavePR"  runat="server" Text="Update Transfer Request"  ValidationGroup="btnSavePR1"  CssClass="btn btn-primary pull-right" OnClick="btnSavePR_Click"></asp:Button>
          </div>
        </div>
        </div>
        </div>
