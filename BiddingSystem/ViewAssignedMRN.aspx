<%@ Page Title="" Language="C#" MasterPageFile="~/BiddingAdmin.Master" AutoEventWireup="true" CodeBehind="ViewAssignedMRN.aspx.cs" Inherits="BiddingSystem.ViewAssignedMRN" %>
        ...
        <asp:UpdatePanel ID="Updatepanel1" runat="server">
            <ContentTemplate>
                <section class="content-header">
                    <h1>View Submitted MRN <small></small></h1>
                    <ol class="breadcrumb">
                        <li><a href="AdminDashboard.aspx"><i class="fa fa-dashboard"></i> Home</a></li>
                        <li class="active">View Submitted MRN </li>
                    </ol>
                </section>
                <br />
                ...
                <div class="panel panel-default" id="panelGridview" runat="server">
                   <div class="panel-heading col-md-12">
                       ...
                       <div class="col-md-8">
                            <h3 class="panel-title h-100  ">Material Request Notes</h3>
                       </div>
                       <div class="col-md-4">
                             <div class="input-group">
                                ...
                                <div class="input-group-btn">
                                    <%--<button class="btn btn-default" type="submit"><i class="glyphicon glyphicon-search"></i></button>--%>
                                     <%--<asp:Button runat="server" ID="btnSearch" CssClass="btn btn-default" Text="View" OnClick="btnSearch_Click"><i class="glyphicon glyphicon-search"></i></asp:Button>--%>
                                </div>
                            </div>
                       </div>
                   </div>
