<%@ Page Title="" Language="C#" MasterPageFile="~/BiddingAdmin.Master" AutoEventWireup="true" CodeBehind="CustomerViewMyPO.aspx.cs" Inherits="BiddingSystem.CustomerViewMyPO" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentSection" runat="server">
    ...
    <h1>
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">View My Purchase Orders </li>
      </ol>
    </section>
                <br />
                           ...
                           <%-- <asp:TextBox ID="txtFDt" runat="server" CssClass="txtFDt"></asp:TextBox>--%>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                  ...
                                  <asp:TextBox ID="txtPrCode" runat="server" CssClass="form-control" PlaceHolder="LCL1 / IMP1" autocomplete="off"></asp:TextBox>
                         </div>
                        <div class="col-md-2">
