<%@ Page Language="C#" MasterPageFile="~/BiddingAdmin.Master" AutoEventWireup="true" CodeBehind="AssignStoreKeeper.aspx.cs" Inherits="BiddingSystem.AssignStoreKeeper" %>
        ...
        <div class="modal-dialog">
            ...
            <div class="box box-info">
                    ...
                    <div class="box-body">
                        ...
                        <div class="row">
                            <div class="col-md-4 col-md-push-4">
                                ...
                                <asp:DropDownList ID="ddlStoreKeeper" runat="server" CssClass="form-control"></asp:DropDownList>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <asp:Panel ID="PnlExpensiveApproval" runat="server" Visible="false">
                                <div class="col-xs-3 col-sm-3 text-center">
                                    <asp:Image ID="imgExpApprovedBySignature" Style="width: 100px; height:50px;" runat="server" /><br />
                                    <asp:Label runat="server" ID="lblExpApprovedByName"></asp:Label><br />
                                    <asp:Label runat="server" ID="lblExpApprovedByDate"></asp:Label><br />
                                    <b id="lblExpenseApprovalText" runat="server"></b>
                                    <hr style="padding-left:10px; padding-right:10px;" />
                                    <strong>REMARKS</strong><br />
                                    <asp:Label runat="server" ID="lblexpApprovalRemark" CssClass="text-left" style="padding-left:10px;"></asp:Label>
                    ...
                    <div class="box-footer no-print">
                        ...
                        <asp:Button runat="server" ID="btnAssign" CssClass="btn btn-success pull-right" Text="Assign" OnClick="lbtnAssign_Click" />
                    </div>
                </div>                    
