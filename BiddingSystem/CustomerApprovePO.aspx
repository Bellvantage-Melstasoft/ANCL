<%@ Page Title="" Language="C#" MasterPageFile="~/BiddingAdmin.Master" AutoEventWireup="true" CodeBehind="CustomerApprovePO.aspx.cs" Inherits="BiddingSystem.CustomerApprovePO" %>
...
<section class="content-header">
	<h1>
	  ...
	  <ol class="breadcrumb">
		...
		<li class="active">Approval of Purchase Order </li>
	  </ol>
	</section>
	<br />
	...
	<asp:UpdatePanel ID="Updatepanel1" runat="server">
	  ...
	  <div class="box box-info" id="panelPurchaseRequset" runat="server">
		<div class="box-header with-border">
		  <h3 class="box-title" >Approval of Purchase Order</h3>
